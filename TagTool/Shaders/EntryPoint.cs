...
namespace TagTool.Shaders
{
    ...
    public enum EntryPointBitMask : int
    {
        ...
        Stipple = 1 << 18,
        Single_Pass_Per_Pixel = 1 << 19,
        Single_Pass_Per_Vertex = 1 << 20,
        //Single_Pass_Single_Probe = 1 << 21,
        //Single_Pass_Single_Probe_Ambient = 1 << 22,
        //Imposter_Static_Sh = 1 << 23,
        //Imposter_Static_Prt_Ambient = 1 << 24,
        //Dynamic_Light_Hq_Shadows = 1 << 25,
        //Dynamic_Light_Hq_Cinematic_Shadows = 1 << 26,
        //Static_Nv_Sh = 1 << 27,
        //Kernel5_Non_Xenon_Output = 1 << 28,
        //Depth_To_Rgba_Pack = 1 << 29,
        //Linear_Depth_Downsample = 1 << 30,
        Z_Only = 1 << 21,
        Sfx_Distort = 1 << 22,
    }
