...
{
    [TagStructure(Size = 0x3390, MinVersion = CacheVersion.HaloOnlineED, MaxVersion = CacheVersion.HaloOnlineED)]
    public class CacheFileHeaderHaloOnlineED : CacheFileHeader
    {
        //
        // Header definition
        //
