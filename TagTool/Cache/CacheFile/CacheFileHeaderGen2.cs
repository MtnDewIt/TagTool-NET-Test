...
{
    [TagStructure(Size = 0x380, MinVersion = CacheVersion.Halo2Retail, MaxVersion = CacheVersion.Halo2Retail, Platform = CachePlatform.MCC)]
    ...
    public class CacheFileHeaderGen2 : CacheFileHeader
    {
        ...
        [TagField(MinVersion = CacheVersion.Halo2Retail, MaxVersion = CacheVersion.Halo2Retail, Platform = CachePlatform.MCC)]
        public CacheFileEngineVersion EngineVersion;
        [TagField(MinVersion = CacheVersion.Halo2Retail, MaxVersion = CacheVersion.Halo2Retail, Platform = CachePlatform.MCC)]
        public CacheFilePlatformType PlatformType;

        [TagField(MinVersion = CacheVersion.Halo2Retail, MaxVersion = CacheVersion.Halo2Retail, Platform = CachePlatform.MCC, Length = 0x2, Flags = TagFieldFlags.Padding)] 
        ...
        [TagField(Length = 0x10, MinVersion = CacheVersion.Halo2Retail, MaxVersion = CacheVersion.Halo2Retail, Platform = CachePlatform.MCC)]
        ...
        [TagField(Length = 256, MinVersion = CacheVersion.Halo2Retail, MaxVersion = CacheVersion.Halo2Retail, Platform = CachePlatform.MCC)]
        ...
        [TagField(Length = 0x14, MinVersion = CacheVersion.Halo2Retail, MaxVersion = CacheVersion.Halo2Retail, Platform = CachePlatform.MCC)]
        ...
        [TagField(Length = 0x504, MinVersion = CacheVersion.Halo2Vista, MaxVersion = CacheVersion.Halo2Vista, Platform = CachePlatform.Original, Flags = TagFieldFlags.Padding)]
        ...
        [TagField(Length = 0x64, MinVersion = CacheVersion.Halo2Retail, MaxVersion = CacheVersion.Halo2Retail, Platform = CachePlatform.MCC, Flags = TagFieldFlags.Padding)]
