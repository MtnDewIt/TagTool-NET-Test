...
{
    [TagStructure(Size = 0x25DC, MinVersion = CacheVersion.Halo3Retail, MaxVersion = CacheVersion.Halo3XboxOne)]
    ...
    public class SharedResourceUsage : TagStructure
    {
        ...
        [TagField(Length = 320, MinVersion = CacheVersion.Halo3Retail, MaxVersion = CacheVersion.HaloReachBeta)]
        [TagField(Length = 1024, MinVersion = CacheVersion.HaloReach, MaxVersion = CacheVersion.HaloReach)]
        [TagField(Length = 3600, MinVersion = CacheVersion.Halo4E3, MaxVersion = CacheVersion.Halo2AMP)]
        ...
        [TagField(Length = 0x4, MinVersion = CacheVersion.Halo3Retail, MaxVersion = CacheVersion.Halo3XboxOne)]
        ...
        [TagStructure(Size = 0xAC, MinVersion = CacheVersion.Halo3Retail, MaxVersion = CacheVersion.Halo3XboxOne)]
        ...
        public class InsertionPointResourceUsage : TagStructure
        {
            ...
            [TagField(Length = 0x8, MinVersion = CacheVersion.Halo4E3, MaxVersion = CacheVersion.Halo2AMP)]
            public byte[] Data04;

            [TagField(Length = 32, MinVersion = CacheVersion.Halo3Retail, MaxVersion = CacheVersion.HaloReachBeta)]
            [TagField(Length = 64, MinVersion = CacheVersion.HaloReach, MaxVersion = CacheVersion.HaloReach)]
            [TagField(Length = 256, MinVersion = CacheVersion.Halo4E3, MaxVersion = CacheVersion.Halo2AMP)]
            public uint[] SharedRequiredLocations;

            [TagField(Length = 10, MinVersion = CacheVersion.Halo3Retail, MaxVersion = CacheVersion.HaloReachBeta)]
            [TagField(Length = 32, MinVersion = CacheVersion.HaloReach, MaxVersion = CacheVersion.HaloReach)]
            [TagField(Length = 128, MinVersion = CacheVersion.Halo4E3, MaxVersion = CacheVersion.Halo2AMP)]
