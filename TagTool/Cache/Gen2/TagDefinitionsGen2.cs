...
namespace TagTool.Cache.Gen2
{
    public class TagDefinitionsGen2 : TagDefinitions
    {
        ...
        private static readonly CachedDefinitions Gen2Definitions = GetCachedDefinitions(new Dictionary<TagGroup, Type>
        {
            ...
            { new TagGroupGen2("devi", "device"), null /*typeof(Device)*/},
            ...
            { new TagGroupGen2("garb", "garbage"), typeof(Garbage) },
            ...
            { new TagGroupGen2("item", "obje", "item"), null /*typeof(Item)*/},
            ...
            { new TagGroupGen2("lifi", "device_light_fixture"), typeof(DeviceLightFixture) },
            ...
            { new TagGroupGen2("obje", "object"), null /*typeof(GameObject)*/ },
            { new TagGroupGen2("part", "particle_old"), null /*typeof(ParticleOld)*/ },
            { new TagGroupGen2("pctl", "particle_system"), null /*typeof(ParticleSystem)*/ },
            ...
            { new TagGroupGen2("unit", "obje", "unit"), null /*typeof(Unit)*/},
