...
{
    [TagStructure(Size = 0x800, MinVersion = CacheVersion.HaloCustomEdition, MaxVersion = CacheVersion.HaloCustomEdition, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHaloCustomEdition : CacheFileHeader
    {
        //
        // Header definition
        //
        ...
        public override bool GetCompression() => false;
