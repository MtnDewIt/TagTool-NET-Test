...
{
    [TagStructure(Size = 0x3000, MinVersion = CacheVersion.Halo3Epsilon, MaxVersion = CacheVersion.Halo3Epsilon, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHalo3Epsilon : CacheFileHeader
    {
        //
        // Header definition
        //
        ...
        [TagField(Length = 0x55C, Flags = TagFieldFlags.Padding)]
        public byte[] Padding;
