...
{
    [TagStructure(Size = 0x800, MinVersion = CacheVersion.Halo3March7Delta, MaxVersion = CacheVersion.Halo3March7Delta)]
    public class CacheFileHeaderHalo3March7Delta : CacheFileHeader
    {
        //
        // Header definition
        //
