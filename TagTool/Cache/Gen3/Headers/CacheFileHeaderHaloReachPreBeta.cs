...
{
    [TagStructure(Size = 0x4000, MinVersion = CacheVersion.HaloReachPreBeta, MaxVersion = CacheVersion.HaloReachPreBeta, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHaloReachPreBeta : CacheFileHeader
    {
        //
        // Header definition
        //
        ...
        [TagField(Length = 0x11E0, Flags = TagFieldFlags.Padding)]
        public byte[] Padding;
