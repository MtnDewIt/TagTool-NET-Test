...
{
    [TagStructure(Size = 0x4000, MinVersion = CacheVersion.HaloReachAlpha, MaxVersion = CacheVersion.HaloReachAlpha, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHaloReachAlpha : CacheFileHeader
    {
        //
        // Header definition
        //
