...
{
    [TagStructure(Size = 0xA000, MinVersion = CacheVersion.HaloReach, MaxVersion = CacheVersion.HaloReach, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHaloReach : CacheFileHeader
    {
        //
        // Header definition
        //
        ...
        [TagField(Length = 0x18A4, Flags = TagFieldFlags.Padding)]
        public byte[] Padding;
