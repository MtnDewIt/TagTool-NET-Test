...
{
    [TagStructure(Size = 0x800, MinVersion = CacheVersion.Halo3March8Delta, MaxVersion = CacheVersion.Halo3March8Delta)]
    public class CacheFileHeaderHalo3March8Delta : CacheFileHeader
    {
        //
        // Header definition
        //
