...
{
    [TagStructure(Size = 0x800, MinVersion = CacheVersion.Halo3March9Delta, MaxVersion = CacheVersion.Halo3March9Delta)]
    public class CacheFileHeaderHalo3March9Delta : CacheFileHeader
    {
        //
        // Header definition
        //
