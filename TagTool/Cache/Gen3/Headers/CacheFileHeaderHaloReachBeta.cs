...
{
    [TagStructure(Size = 0x4000, MinVersion = CacheVersion.HaloReachBeta, MaxVersion = CacheVersion.HaloReachBeta, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHaloReachBeta : CacheFileHeader
    {
        //
        // Header definition
        //
