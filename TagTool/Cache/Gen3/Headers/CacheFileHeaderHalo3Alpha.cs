...
{
    [TagStructure(Size = 0x800, MinVersion = CacheVersion.Halo3Alpha, MaxVersion = CacheVersion.Halo3Alpha, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHalo3Alpha : CacheFileHeader
    {
        //
        // Header definition
        //
