...
{
    [TagStructure(Size = 0x3000, MinVersion = CacheVersion.Halo3DLC, MaxVersion = CacheVersion.Halo3DLC, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHalo3DLC : CacheFileHeader
    {
        //
        // Header definition
        //
        ...
        [TagField(Length = (int)CacheFilePartitionTypeDLC.Count)]
        ...
        [TagField(Length = 0x548, Flags = TagFieldFlags.Padding)]
        public byte[] Padding;
