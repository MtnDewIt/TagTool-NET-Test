...
{
    [TagStructure(Size = 0x3000, MinVersion = CacheVersion.Halo3ODST, MaxVersion = CacheVersion.Halo3ODST, Platform = CachePlatform.Original)]
    public class CacheFileHeaderHalo3ODST : CacheFileHeader
    {
        //
        // Header definition
        //
        ...
        [TagField(Length = 0x1E0, Flags = TagFieldFlags.Padding)]
        public byte[] Padding;
