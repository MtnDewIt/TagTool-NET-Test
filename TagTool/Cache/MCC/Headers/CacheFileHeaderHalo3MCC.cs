...
{
    [TagStructure(Size = 0x4000, MinVersion = CacheVersion.Halo3Retail, MaxVersion = CacheVersion.Halo3Retail, Platform = CachePlatform.MCC)]
    public class CacheFileHeaderHalo3MCC : CacheFileHeader
    {
        //
        // Header definition
        //
