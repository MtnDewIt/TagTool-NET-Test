...
{
    [TagStructure(Size = 0x800, MinVersion = CacheVersion.HaloCustomEdition, MaxVersion = CacheVersion.HaloCustomEdition, Platform = CachePlatform.MCC)]
    public class CacheFileHeaderHalo1MCC : CacheFileHeader
    {
        //
        // Header definition
        //
