...
{
    [TagStructure(Size = 0x3000, MinVersion = CacheVersion.Halo3Ares, MaxVersion = CacheVersion.Halo3Ares, Platform = CachePlatform.MCC)]
    public class CacheFileHeaderHalo3Ares : CacheFileHeader
    {
        //
        // Header definition
        //
