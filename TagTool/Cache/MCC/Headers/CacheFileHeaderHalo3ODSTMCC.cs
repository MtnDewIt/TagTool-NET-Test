...
{
    [TagStructure(Size = 0x4000, MinVersion = CacheVersion.Halo3ODST, MaxVersion = CacheVersion.Halo3ODST, Platform = CachePlatform.MCC)]
    public class CacheFileHeaderHalo3ODSTMCC : CacheFileHeader
    {
        //
        // Header definition
        //
