...
namespace TagTool.BlamFile.Chunks
{
    ...
    [TagStructure(Size = 0x2D4D4, MinVersion = CacheVersion.Halo4, MaxVersion = CacheVersion.H2AMP, Platform = CachePlatform.MCC)]
    public class BlfSavedFilmHeader : BlfChunkHeader
    {
        ...
        [TagField(Length = 0x2D4D4, MinVersion = CacheVersion.Halo4, MaxVersion = CacheVersion.H2AMP, Platform = CachePlatform.MCC)]
