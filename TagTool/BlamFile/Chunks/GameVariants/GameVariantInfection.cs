...
namespace TagTool.BlamFile.Chunks.GameVariants
{
    ...
    public class GameVariantInfection : GameVariantBase
    {
        ...
        public static GameVariantInfection Decode(BitStreamReader stream)
        {
            ...
            variant.ZombieKillPoints = (sbyte)stream.ReadSignedInteger(5);
            variant.InfectionPoints = (sbyte)stream.ReadSignedInteger(5);
            variant.SafeHavenArrivalPoints = (sbyte)stream.ReadSignedInteger(5);
            variant.SuicidePoints = (sbyte)stream.ReadSignedInteger(5);
            variant.BetrayalPoints = (sbyte)stream.ReadSignedInteger(5);
            variant.LastManBonusPoints = (sbyte)stream.ReadSignedInteger(5);
