    ...
    class BlenderPhmoMoppUtil
    {
        ...
        public static MemoryStream GenerateForBlenderPhmoJson(string jsonString)
        {
            ...
            try
            {
                ...
                var info = TagStructure.GetTagStructureInfo(resource.GetType(), CacheVersion.Eldorado235640, CachePlatform.Original);

                new TagSerializer(CacheVersion.Eldorado235640, CachePlatform.Original).Serialize(dataContext, resource);
