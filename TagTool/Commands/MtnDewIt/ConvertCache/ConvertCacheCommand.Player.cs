        ...
        public void ApplyPlayerPatches() 
        {
            using (var stream = Cache.OpenCacheReadWrite()) 
            {
                ...
                foreach (var tag in CacheContext.TagCache.NonNull()) 
                {
                    ...
                    if (tag.IsInGroup("mode") && tag.Name == $@"objects\characters\masterchief\mp_masterchief\mp_masterchief") 
                    {
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_cobra_visor") 
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag); rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    ...
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_cobra"),
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_cobra_bump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_intruder_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag); rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                            new RenderMethod.RenderMethodOptionIndex
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_marathon_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag); rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                            new RenderMethod.RenderMethodOptionIndex
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_marathon"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_marathon_bump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_markv_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag); rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                            new RenderMethod.RenderMethodOptionIndex
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_markv"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_markv_zbump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_ninja_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag); rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                            new RenderMethod.RenderMethodOptionIndex
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_ninja"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_ninja_bump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_odst_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag); rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                            new RenderMethod.RenderMethodOptionIndex
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_odst_helmet_diffuse"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\odst\bitmaps\odst_helmet_zbump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_regulator_visor")
                    {
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_regulator"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_regulator_zbump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_rogue_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag);
                        rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_rogue"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_rogue_zbump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_ryu_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag);
                        rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_ryu"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_ryu_bump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_scout_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag);
                        rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_scout"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\mp_scout_zbump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                    ...
                    if (tag.IsInGroup("rmsh") && tag.Name == $@"objects\characters\masterchief\shaders\mp_visor")
                    {
                        var rmsh = CacheContext.Deserialize<Shader>(stream, tag);
                        rmsh.Options = new List<RenderMethod.RenderMethodOptionIndex>
                        {
                        ...
                        rmsh.ShaderProperties = new List<RenderMethod.RenderMethodPostprocessBlock>
                        {
                            new RenderMethod.RenderMethodPostprocessBlock
                            {
                                ...
                                TextureConstants = new List<RenderMethod.RenderMethodPostprocessBlock.TextureConstant>
                                {
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\visor_realtime"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 0,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    ...
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
                                    {
                                        Bitmap = GetCachedTag<Bitmap>($@"objects\characters\masterchief\bitmaps\visor_realtime_bump"),
                                        FilterMode = RenderMethod.RenderMethodPostprocessBlock.TextureConstant.SamplerFilterMode.Anisotropic4EXPENSIVE,
                                        TextureTransformConstantIndex = 3,
                                    },
                                    new RenderMethod.RenderMethodPostprocessBlock.TextureConstant
