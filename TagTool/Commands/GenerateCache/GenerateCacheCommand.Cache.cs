...
namespace TagTool.Commands.GenerateCache
{
    partial class GenerateCacheCommand : Command
    {
        ...
        public static readonly string[] MS23Shaders = new[]
        {
            ...
            @"rasterizer\shaders\decorator_edit",
            @"rasterizer\shaders\hdr_retrieve",
            @"rasterizer\shaders\smirnov",
            @"rasterizer\shaders\fxaa",
            @"rasterizer\shaders\unknown_94",
            @"rasterizer\shaders\sniper_scope_stencil_pc",
            @"rasterizer\shaders\ssao",
            @"rasterizer\shaders\ssao_blur",
            @"rasterizer\shaders\unknown_98",
            @"rasterizer\shaders\lightshafts",
            @"rasterizer\shaders\radial_blur",
            @"rasterizer\shaders\unknown_101",
            @"rasterizer\shaders\unknown_102",
            @"rasterizer\shaders\unknown_103",
            @"rasterizer\shaders\unknown_104",
            @"rasterizer\shaders\unknown_105",
            @"rasterizer\shaders\unknown_106",
            @"rasterizer\shaders\unknown_107",
            @"rasterizer\shaders\hud_camera_nightvision",
            @"rasterizer\shaders\unknown_109",
        };
