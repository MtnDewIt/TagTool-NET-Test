...
namespace TagTool.Commands.Editing
{
    class MoveBlockElementCommand : Command
    {
        ...
        public MoveBlockElementCommand(CommandContextStack contextStack, GameCache cache, CacheVersion version, CachePlatform platform, object objectFile, TagStructureInfo structure, object owner)
            : base(true,

                  "MoveBlockElement",
                  $"Moves a block element from a specified index of a specific tag block in the current {structure.Types[0].Name} definition.",

                  "MoveBlockElement <block name> <Element index> <new Element index>",
                  $"Moves a block element from a specified index of a specific tag block in the current {structure.Types[0].Name} definition.")
        {
