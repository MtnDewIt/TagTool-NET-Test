...
namespace TagTool.Commands.CollisionModels
{
    class MoppDataCommand : Command
    {
        ...
        public MoppDataCommand(ref CollisionModel definition) :
            base(true,
        ...
        private void ImportMopps(string file)
        {
            ...
            var moppData = Definition.Regions[0].Permutations[0].BspMoppCodes[0];
        ...
        private void ParseMopps(string file)
        {
            ...
            using (var fileWriter = new StreamWriter(fileStream))
            {
                ...
                var moppData = Definition.Regions[0].Permutations[0].BspMoppCodes[0].Data;
                var print = true;
