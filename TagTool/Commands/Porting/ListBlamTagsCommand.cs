...
{
    class ListBlamTagsCommand : Command
    {
        private GameCache Cache { get; }

        public ListBlamTagsCommand(GameCache cache)
            : base(true,

                  "ListBlamTags",
                  "Lists tag instances of the specified tag groups in the current Blam cache file.",

                  "ListBlamTags [TagGroup]... {Is|From|To:} {SearchType:}...",
