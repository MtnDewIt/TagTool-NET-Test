...
namespace TagTool.MtnDewIt.Animations
{
    public class InlineAnimationImporter
    {
        ...
        {
            List<Node> defaultNodes = InlineAnimationDefaultNodeHelper.GetNodeDefaultValues(CacheContext, CacheStream, Animation);
