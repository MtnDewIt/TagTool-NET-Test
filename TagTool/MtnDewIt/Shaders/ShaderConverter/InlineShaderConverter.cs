...
using static TagTool.MtnDewIt.Shaders.ShaderMatching.InlineShaderMatcher;
...
namespace TagTool.MtnDewIt.Shaders.ShaderConverter
{
    ...
    public class InlineShaderConverter 
    {
        ...
        private InlineShaderMatcher Matcher;
        ...
        public InlineShaderConverter(GameCache cache,
            GameCache blamCache,
            Stream stream,
            Stream blamStream,
            RenderMethod renderMethod,
            RenderMethod blamRenderMethod,
            InlineShaderMatcher matcher)
        {
            Cache = cache;
            BlamCache = blamCache;
            RenderMethod = renderMethod;
