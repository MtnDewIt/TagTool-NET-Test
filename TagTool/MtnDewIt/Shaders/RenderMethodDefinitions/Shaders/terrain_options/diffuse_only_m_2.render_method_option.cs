...
{
    public class shaders_terrain_options_diffuse_only_m_2_render_method_option : RenderMethodData
    {
        public shaders_terrain_options_diffuse_only_m_2_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\terrain_options\diffuse_only_m_2");
