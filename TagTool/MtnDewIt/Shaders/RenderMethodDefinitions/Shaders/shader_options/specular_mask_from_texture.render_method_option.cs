...
{
    public class shaders_shader_options_specular_mask_from_texture_render_method_option : RenderMethodData
    {
        public shaders_shader_options_specular_mask_from_texture_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\shader_options\specular_mask_from_texture");
            ...
            rmop.Parameters = new List<RenderMethodOption.ParameterBlock>
            {
                ...
                {
                    Name = CacheContext.StringTable.GetOrAddString($@"specular_mask_texture"),
