...
{
    public class shaders_shader_options_albedo_constant_render_method_option : RenderMethodData
    {
        public shaders_shader_options_albedo_constant_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\shader_options\albedo_constant");
            ...
            rmop.Parameters = new List<RenderMethodOption.ParameterBlock>
            {
                new RenderMethodOption.ParameterBlock
                {
                    ...
                    AnisotropyAmount = 0,
                    DefaultColor = new ArgbColor(255, 192, 192, 192),
