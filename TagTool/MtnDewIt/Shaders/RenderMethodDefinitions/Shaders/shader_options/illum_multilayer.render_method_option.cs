...
{
    public class shaders_shader_options_illum_multilayer_render_method_option : RenderMethodData
    {
        public shaders_shader_options_illum_multilayer_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\shader_options\illum_multilayer");
