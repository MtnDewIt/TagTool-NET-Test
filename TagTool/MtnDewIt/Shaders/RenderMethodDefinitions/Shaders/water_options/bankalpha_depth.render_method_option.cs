...
{
    public class shaders_water_options_bankalpha_depth_render_method_option : RenderMethodData
    {
        public shaders_water_options_bankalpha_depth_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\water_options\bankalpha_depth");
            ...
            rmop.Parameters = new List<RenderMethodOption.ParameterBlock>
            {
                ...
                {
                    Name = CacheContext.StringTable.GetOrAddString($@"bankalpha_infuence_depth"),
