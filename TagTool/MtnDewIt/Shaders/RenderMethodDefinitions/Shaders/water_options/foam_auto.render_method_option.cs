...
{
    public class shaders_water_options_foam_auto_render_method_option : RenderMethodData
    {
        public shaders_water_options_foam_auto_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\water_options\foam_auto");
