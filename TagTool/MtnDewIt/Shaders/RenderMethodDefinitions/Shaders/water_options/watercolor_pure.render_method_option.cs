...
{
    public class shaders_water_options_watercolor_pure_render_method_option : RenderMethodData
    {
        public shaders_water_options_watercolor_pure_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\water_options\watercolor_pure");
            ...
            rmop.Parameters = new List<RenderMethodOption.ParameterBlock>
            {
                ...
                {
                    Name = CacheContext.StringTable.GetOrAddString($@"water_color_pure"),
                    ...
                    AnisotropyAmount = 0,
                    DefaultColor = new ArgbColor(0, 1, 16, 12),
