                ...
                new RenderMethodDefinition.CategoryBlock
                {
                    ...
                    ShaderOptions = new List<RenderMethodDefinition.CategoryBlock.ShaderOption>
                    {
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_two_change_color_anim_overlay"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_chameleon"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_two_change_color_chameleon"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_chameleon_masked"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_color_mask_hard_light"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_two_change_color_tex_overlay"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_chameleon_albedo_masked"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_custom_cube"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_two_color"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\albedo_emblem"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_albedo_default_vs"),
                ...
                new RenderMethodDefinition.CategoryBlock
                {
                    ...
                    ShaderOptions = new List<RenderMethodDefinition.CategoryBlock.ShaderOption>
                    {
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\bump_detail_masked"),
                            VertexFunction = CacheContext.StringTable.GetOrAddString($@"calc_bumpmap_detail_vs"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\bump_detail_plus_detail_masked"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\bump_detail_unorm"),
                            VertexFunction = StringId.Invalid,
                ...
                new RenderMethodDefinition.CategoryBlock
                {
                    ...
                    ShaderOptions = new List<RenderMethodDefinition.CategoryBlock.ShaderOption>
                    {
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\material_diffuse_only"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\material_cook_torrance_rim_fresnel"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\material_foliage"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\glass_material"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\material_organism_option"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\single_lobe_phong"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\material_car_paint"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\material_hair_option"),
                            VertexFunction = StringId.Invalid,
                ...
                new RenderMethodDefinition.CategoryBlock
                {
                    ...
                    ShaderOptions = new List<RenderMethodDefinition.CategoryBlock.ShaderOption>
                    {
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\illum_simple_four_change_color"),
                            VertexFunction = StringId.Invalid,
                            PixelFunction = CacheContext.StringTable.GetOrAddString($@"calc_self_illumination_simple_ps"),
                        },
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\illum_change_color"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = GenerateTag<RenderMethodOption>($@"shaders\shader_options\illum_change_color_detail"),
                            VertexFunction = StringId.Invalid,
