...
{
    public class shaders_custom_options_alpha_test_multiply_map_render_method_option : RenderMethodData
    {
        public shaders_custom_options_alpha_test_multiply_map_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\custom_options\alpha_test_multiply_map");
