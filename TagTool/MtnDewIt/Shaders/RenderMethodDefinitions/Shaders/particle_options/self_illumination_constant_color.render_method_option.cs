...
{
    public class shaders_particle_options_self_illumination_constant_color_render_method_option : RenderMethodData
    {
        public shaders_particle_options_self_illumination_constant_color_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\particle_options\self_illumination_constant_color");
