...
{
    public class shaders_particle_options_albedo_diffuse_plus_sprite_alpha_render_method_option : RenderMethodData
    {
        public shaders_particle_options_albedo_diffuse_plus_sprite_alpha_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\particle_options\albedo_diffuse_plus_sprite_alpha");
