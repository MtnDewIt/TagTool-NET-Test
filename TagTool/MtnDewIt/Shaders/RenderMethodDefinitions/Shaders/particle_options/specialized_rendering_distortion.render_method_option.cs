...
{
    public class shaders_particle_options_specialized_rendering_distortion_render_method_option : RenderMethodData
    {
        public shaders_particle_options_specialized_rendering_distortion_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\particle_options\specialized_rendering_distortion");
            ...
            rmop.Parameters = new List<RenderMethodOption.ParameterBlock>
            {
                ...
                {
                    Name = CacheContext.StringTable.GetOrAddString($@"distortion_scale"),
