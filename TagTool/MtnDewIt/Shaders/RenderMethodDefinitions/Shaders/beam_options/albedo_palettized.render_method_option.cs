...
{
    public class shaders_beam_options_albedo_palettized_render_method_option : RenderMethodData
    {
        public shaders_beam_options_albedo_palettized_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\beam_options\albedo_palettized");
