...
{
    public class shaders_light_volume_options_albedo_diffuse_only_render_method_option : RenderMethodData
    {
        public shaders_light_volume_options_albedo_diffuse_only_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\light_volume_options\albedo_diffuse_only");
