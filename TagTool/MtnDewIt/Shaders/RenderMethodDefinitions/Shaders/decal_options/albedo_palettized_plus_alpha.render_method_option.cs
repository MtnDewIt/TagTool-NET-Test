...
{
    public class shaders_decal_options_albedo_palettized_plus_alpha_render_method_option : RenderMethodData
    {
        public shaders_decal_options_albedo_palettized_plus_alpha_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\decal_options\albedo_palettized_plus_alpha");
