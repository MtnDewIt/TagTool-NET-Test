...
{
    public class shaders_decal_options_bump_mapping_standard_render_method_option : RenderMethodData
    {
        public shaders_decal_options_bump_mapping_standard_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\decal_options\bump_mapping_standard");
