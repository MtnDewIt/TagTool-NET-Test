...
{
    public class shaders_screen_options_overlay_tint_add_color_render_method_option : RenderMethodData
    {
        public shaders_screen_options_overlay_tint_add_color_render_method_option(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\screen_options\overlay_tint_add_color");
            ...
            rmop.Parameters = new List<RenderMethodOption.ParameterBlock>
            {
                ...
                new RenderMethodOption.ParameterBlock
                {
                    Name = CacheContext.StringTable.GetOrAddString($@"add_color"),
                    Type = RenderMethodOption.ParameterBlock.OptionDataType.ArgbColor,
                    RenderMethodExtern = RenderMethodExtern.none,
                    DefaultSamplerBitmap = null,
