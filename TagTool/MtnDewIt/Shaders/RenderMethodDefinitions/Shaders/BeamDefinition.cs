...
{
    public class BeamDefinition : RenderMethodData 
    {
        public BeamDefinition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = Cache.TagCache.GetTag<RenderMethodDefinition>($@"shaders\beam");
            var rmdf = CacheContext.Deserialize<RenderMethodDefinition>(Stream, tag);
            rmdf.GlobalOptions = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\beam_options\global_beam_options");
                ...
                new RenderMethodDefinition.CategoryBlock
                {
                    ...
                    ShaderOptions = new List<RenderMethodDefinition.CategoryBlock.ShaderOption>
                    {
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\beam_options\albedo_diffuse_only"),
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\beam_options\albedo_palettized"),
                            VertexFunction = StringId.Invalid,
                        ...
                        new RenderMethodDefinition.CategoryBlock.ShaderOption
                        {
                            ...
                            Option = Cache.TagCache.GetTag<RenderMethodOption>($@"shaders\beam_options\albedo_palettized_plus_alpha"),
                            VertexFunction = StringId.Invalid,
            ...
            rmdf.GlobalPixelShader = Cache.TagCache.GetTag<GlobalPixelShader>($@"shaders\beam_shared_pixel_shaders");
            rmdf.GlobalVertexShader = Cache.TagCache.GetTag<GlobalVertexShader>($@"shaders\beam_shared_vertex_shaders");
