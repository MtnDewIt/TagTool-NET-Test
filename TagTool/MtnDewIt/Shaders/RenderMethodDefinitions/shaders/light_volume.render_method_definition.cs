...
{
    public class shaders_light_volume_render_method_definition : RenderMethodData
    {
        public shaders_light_volume_render_method_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
