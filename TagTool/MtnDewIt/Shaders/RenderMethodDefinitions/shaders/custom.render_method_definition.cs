...
{
    public class shaders_custom_render_method_definition : RenderMethodData
    {
        public shaders_custom_render_method_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
