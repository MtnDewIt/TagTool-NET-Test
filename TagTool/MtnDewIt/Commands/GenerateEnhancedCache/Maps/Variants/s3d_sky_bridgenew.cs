...
{
    public class s3d_sky_bridgenew : MapVariantFile
    {
        public s3d_sky_bridgenew(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Scenario>($@"levels\multi\s3d_sky_bridgenew\s3d_sky_bridgenew");
            ...
            BlfData blfData = new BlfData(Cache.Version, CachePlatform.Original)
            {
                ...
                Scenario = new BlfDataScenario
                {
                    ...
                    Descriptions = new NameUnicode128[12]
                    {
                        new NameUnicode128
                        {
                            Name = $@"Seongnam's state-of-the-art clinics and labs contain knowledge worth dying for. 6-12 players.",
                        },
                        new NameUnicode128
                        {
                        },
                    ...
                    ImageName = $@"m_s3d_sky_bridgenew",
                    MapName = $@"s3d_sky_bridgenew",
                    MapIndex = 14,
                ...
                MapVariant = new BlfDataMapVariant
                {
                    MapVariant = new MapVariantData
                    {
                        ...
                        {
                            Name = $@"Sky Bridge",
                            Description = $@"Seongnam's state-of-the-art clinics and labs contain knowledge worth dying for. 6-12 players",
                        ...
                        VariantVersion = 12,
                        MapId = 709,
                        WorldBounds = new RealRectangle3d(-129.6832f, 194.5809f, -75.04865f, 291.8495f, -543.3017f, 174.4842f),
