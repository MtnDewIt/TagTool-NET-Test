                ...
                MapVariant = new BlfDataMapVariant
                {
                    MapVariant = new MapVariantData
                    {
                        ...
                        Quotas = new VariantDataObjectQuota[256]
                        {
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Vehicle>($@"objects\levels\dlc\sidewinder\hornet_lite\hornet_lite").Index,
                                MinimumCount = 0,
                                MaximumCount = 2,
                                PlacedOnMap = 2,
                                MaxAllowed = 255,
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Vehicle>($@"objects\vehicles\scorpion\scorpion").Index,
                                MinimumCount = 0,
                                MaximumCount = 1,
                                PlacedOnMap = 1,
                                MaxAllowed = 255,
