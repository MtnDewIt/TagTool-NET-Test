...
{
    public class s3d_powerhouse : MapVariantFile
    {
        public s3d_powerhouse(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Scenario>($@"levels\multi\s3d_powerhouse\s3d_powerhouse");
            ...
            BlfData blfData = new BlfData(Cache.Version, CachePlatform.Original)
            {
                ...
                Scenario = new BlfDataScenario
                {
                    ...
                    Descriptions = new NameUnicode128[12]
                    {
                        new NameUnicode128
                        {
                            Name = $@"Hydroelectric plants like this one provide clean, sustainable energy for the inhabitants of Reach. 4-12 players.",
                        },
                        new NameUnicode128
                        {
                        },
                    ...
                    ImageName = $@"m_s3d_powerhouse",
                    MapName = $@"s3d_powerhouse",
                    MapIndex = 14,
                ...
                MapVariant = new BlfDataMapVariant
                {
                    MapVariant = new MapVariantData
                    {
                        ...
                        {
                            Name = $@"Powerhouse",
                            Description = $@"Hydroelectric plants like this one provide clean, sustainable energy for the inhabitants of Reach. 4-12 players",
                        ...
                        VariantVersion = 12,
                        MapId = 715,
                        WorldBounds = new RealRectangle3d(-870.4042f, 2093.852f, -1404.576f, 1449.432f, -160.8701f, 429.2813f),
