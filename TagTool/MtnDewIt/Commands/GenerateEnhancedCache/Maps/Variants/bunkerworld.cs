                ...
                MapVariant = new BlfDataMapVariant
                {
                    MapVariant = new MapVariantData
                    {
                        ...
                        Quotas = new VariantDataObjectQuota[256]
                        {
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Scenery>($@"objects\levels\dlc\bunkerworld\sandbag_wall_45corner_bunker\sandbag_wall_45corner_bunker").Index,
                                MinimumCount = 0,
                                MaximumCount = 255,
                                PlacedOnMap = 6,
                                MaxAllowed = 255,
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Scenery>($@"objects\gear\human\military\sandbag_wall_turret\sandbag_wall_turret").Index,
                                MinimumCount = 0,
                                MaximumCount = 255,
                                PlacedOnMap = 2,
                                MaxAllowed = 255,
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Crate>($@"objects\gear\human\military\hu_mil_radio_big\hu_mil_radio_big").Index,
                                MinimumCount = 0,
                                MaximumCount = 2,
                                PlacedOnMap = 2,
                                MaxAllowed = 255,
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Crate>($@"objects\gear\human\industrial\jersey_barrier_short\jersey_barrier_short").Index,
                                MinimumCount = 0,
                                MaximumCount = 1,
                                PlacedOnMap = 1,
                                MaxAllowed = 255,
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Crate>($@"objects\levels\solo\030_outskirts\foliage\bushlow\bushlow").Index,
                                MinimumCount = 0,
                                MaximumCount = 255,
                                PlacedOnMap = 5,
                                MaxAllowed = 255,
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Crate>($@"objects\levels\solo\030_outskirts\foliage\small_bush\small_bush").Index,
                                MinimumCount = 0,
                                MaximumCount = 255,
                                PlacedOnMap = 8,
                                MaxAllowed = 255,
                            ...
                            new VariantDataObjectQuota
                            {
                                ObjectDefinitionIndex = GetCachedTag<Crate>($@"objects\levels\solo\030_outskirts\foliage\bushc\bushc").Index,
                                MinimumCount = 0,
                                MaximumCount = 255,
                                PlacedOnMap = 5,
                                MaxAllowed = 255,
