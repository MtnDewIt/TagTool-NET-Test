...
{
    public class levels_dlc_spacecamp_spacecamp_scenario : TagFile
    {
        public levels_dlc_spacecamp_spacecamp_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
