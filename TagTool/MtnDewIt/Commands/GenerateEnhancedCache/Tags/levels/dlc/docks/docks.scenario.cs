...
{
    public class levels_dlc_docks_docks_scenario : TagFile
    {
        public levels_dlc_docks_docks_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
