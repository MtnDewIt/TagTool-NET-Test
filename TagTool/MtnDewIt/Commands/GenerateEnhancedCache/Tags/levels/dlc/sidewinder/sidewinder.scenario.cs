...
{
    public class levels_dlc_sidewinder_sidewinder_scenario : TagFile
    {
        public levels_dlc_sidewinder_sidewinder_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
