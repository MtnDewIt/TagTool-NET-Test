...
{
    public class levels_dlc_lockout_lockout_scenario : TagFile
    {
        public levels_dlc_lockout_lockout_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
