...
{
    public class levels_dlc_ghosttown_ghosttown_scenario : TagFile
    {
        public levels_dlc_ghosttown_ghosttown_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
