...
{
    public class levels_dlc_armory_armory_scenario : TagFile
    {
        public levels_dlc_armory_armory_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
