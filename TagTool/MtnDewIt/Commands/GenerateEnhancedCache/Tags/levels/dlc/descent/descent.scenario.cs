...
{
    public class levels_dlc_descent_descent_scenario : TagFile
    {
        public levels_dlc_descent_descent_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
