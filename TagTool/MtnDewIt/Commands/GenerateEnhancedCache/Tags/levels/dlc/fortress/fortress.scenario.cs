...
{
    public class levels_dlc_fortress_fortress_scenario : TagFile
    {
        public levels_dlc_fortress_fortress_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
