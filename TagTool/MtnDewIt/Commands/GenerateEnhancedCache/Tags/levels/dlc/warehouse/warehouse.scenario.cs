...
{
    public class levels_dlc_warehouse_warehouse_scenario : TagFile
    {
        public levels_dlc_warehouse_warehouse_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
