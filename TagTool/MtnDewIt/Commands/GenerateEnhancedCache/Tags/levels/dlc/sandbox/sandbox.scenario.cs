...
{
    public class levels_dlc_sandbox_sandbox_scenario : TagFile
    {
        public levels_dlc_sandbox_sandbox_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
