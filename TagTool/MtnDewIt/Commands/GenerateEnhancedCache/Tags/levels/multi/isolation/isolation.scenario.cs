...
{
    public class levels_multi_isolation_isolation_scenario : TagFile
    {
        public levels_multi_isolation_isolation_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
