...
{
    public class levels_multi_salvation_salvation_scenario : TagFile
    {
        public levels_multi_salvation_salvation_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
