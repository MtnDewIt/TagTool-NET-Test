...
{
    public class levels_multi_snowbound_snowbound_scenario : TagFile
    {
        public levels_multi_snowbound_snowbound_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
