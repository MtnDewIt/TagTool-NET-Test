...
{
    public class levels_multi_s3d_waterfall_s3d_waterfall_scenario : TagFile
    {
        public levels_multi_s3d_waterfall_s3d_waterfall_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
