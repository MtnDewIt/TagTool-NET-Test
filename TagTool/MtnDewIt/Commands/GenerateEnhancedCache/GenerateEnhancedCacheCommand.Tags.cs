    ...
    partial class GenerateEnhancedCacheCommand : Command
    {
        public void UpdateTagData()
        {
            using (var stream = Cache.OpenCacheReadWrite())
            {
                ...
                new ui_eldewrito_common_map_bitmaps_s3d_lockout_bitmap(Cache, CacheContext, stream);

                new ui_eldewrito_common_map_bitmaps_s3d_powerhouse_bitmap(Cache, CacheContext, stream);

                new ui_eldewrito_common_map_bitmaps_s3d_reactor_bitmap(Cache, CacheContext, stream);

                new ui_eldewrito_common_map_bitmaps_s3d_sky_bridgenew_bitmap(Cache, CacheContext, stream);
                ...
                new ui_halox_common_roster_animations_player_scale_up_gui_widget_scale_animation_definition(Cache, CacheContext, stream);
                ...
                new levels_ui_mainmenu_objects_spartan_cheap_spartan_cheap_model(Cache, CacheContext, stream);
                ...
                new levels_dlc_armory_armory_scenario(Cache, CacheContext, stream);

                new levels_dlc_bunkerworld_bunkerworld_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_chillout_chillout_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_descent_descent_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_docks_docks_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_fortress_fortress_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_ghosttown_ghosttown_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_lockout_lockout_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_midship_midship_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_sandbox_sandbox_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_sidewinder_sidewinder_scenario(Cache, CacheContext, stream);
                
                new levels_dlc_spacecamp_spacecamp_scenario(Cache, CacheContext, stream);

                new levels_dlc_warehouse_warehouse_scenario(Cache, CacheContext, stream);
                
                new levels_multi_chill_chill_scenario(Cache, CacheContext, stream);
                
                new levels_multi_construct_construct_scenario(Cache, CacheContext, stream);
                ...
                new levels_multi_isolation_isolation_scenario(Cache, CacheContext, stream);
                ...
                new levels_multi_s3d_lockout_s3d_lockout_scenario(Cache, CacheContext, stream);
                
                new levels_multi_s3d_powerhouse_s3d_powerhouse_scenario(Cache, CacheContext, stream);
                
                new levels_multi_s3d_reactor_s3d_reactor_scenario(Cache, CacheContext, stream);
                
                new levels_multi_s3d_sky_bridgenew_s3d_sky_bridgenew_scenario(Cache, CacheContext, stream);
                
                new levels_multi_s3d_turf_s3d_turf_scenario(Cache, CacheContext, stream);
                
                new levels_multi_s3d_waterfall_s3d_waterfall_scenario(Cache, CacheContext, stream);
                
                new levels_multi_salvation_salvation_scenario(Cache, CacheContext, stream);
                
                new levels_multi_shrine_shrine_scenario(Cache, CacheContext, stream);
                
                new levels_multi_snowbound_snowbound_scenario(Cache, CacheContext, stream);
