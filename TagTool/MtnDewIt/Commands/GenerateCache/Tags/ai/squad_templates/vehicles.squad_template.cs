...
{
    public class ai_squad_templates_vehicles_squad_template : TagFile
    {
        public ai_squad_templates_vehicles_squad_template(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
