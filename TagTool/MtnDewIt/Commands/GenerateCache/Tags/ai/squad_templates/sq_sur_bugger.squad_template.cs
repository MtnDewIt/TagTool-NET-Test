...
{
    public class ai_squad_templates_sq_sur_bugger_squad_template : TagFile
    {
        public ai_squad_templates_sq_sur_bugger_squad_template(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
