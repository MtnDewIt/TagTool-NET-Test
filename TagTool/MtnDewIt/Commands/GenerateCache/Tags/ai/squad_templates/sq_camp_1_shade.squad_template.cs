...
{
    public class ai_squad_templates_sq_camp_1_shade_squad_template : TagFile
    {
        public ai_squad_templates_sq_camp_1_shade_squad_template(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
