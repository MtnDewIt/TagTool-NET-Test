...
{
    public class levels_ui_mainmenu_mainmenu_eldewrito_scenario : TagFile
    {
        public levels_ui_mainmenu_mainmenu_eldewrito_scenario(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        public override void TagData()
        {
            ...
            CompileScript(tag, $@"{Program.TagToolDirectory}\Tools\JSON\data\{tag.Name}\scripts\mainmenu_eldewrito.hsc");
        }
    }
}
