...
{
    public class objects_vehicles_warthog_warthog_snow_wrecked_vehicle : TagFile
    {
        public objects_vehicles_warthog_warthog_snow_wrecked_vehicle(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
