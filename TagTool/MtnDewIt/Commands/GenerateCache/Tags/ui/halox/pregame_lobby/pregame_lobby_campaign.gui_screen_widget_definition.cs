...
{
    public class ui_halox_pregame_lobby_pregame_lobby_campaign_gui_screen_widget_definition : TagFile
    {
        public ui_halox_pregame_lobby_pregame_lobby_campaign_gui_screen_widget_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<GuiScreenWidgetDefinition>($@"ui\halox\pregame_lobby\pregame_lobby_campaign");
            ...
            {
                Name = CacheContext.StringTable.GetOrAddString($@"pregame_lobby_campaign"),
            };
                        ...
                        TextWidgets = new List<TextWidget>
                        {
                            new TextWidget
                            {
                                Definition = new GuiTextWidgetDefinition
                                {
                                   ...
                                   ValueIdentifier = CacheContext.StringTable.GetOrAddString($@"campaign_difficulty"),
                            ...
                            new TextWidget
                            {
                                Definition = new GuiTextWidgetDefinition
                                {
                                    ...
                                    GuiRenderBlock = new GuiDefinition
                                   {
                                       Name = CacheContext.StringTable.GetOrAddString($@"campaign_insertion_point"),
                                       Bounds720p = new Rectangle2d(686, 116, 725, 704),
                                       AnimationCollection = GetCachedTag<GuiWidgetAnimationCollectionDefinition>($@"ui\halox\main_menu\animations\lobby_slide"),
                                   },
                                   ValueIdentifier = CacheContext.StringTable.GetOrAddString($@"campaign_insertion_point"),
                                   TextColorPreset = CacheContext.StringTable.GetOrAddString($@"ice"),
                                   CustomFont = WidgetFontValue.BodyText,
                                },
                            },
