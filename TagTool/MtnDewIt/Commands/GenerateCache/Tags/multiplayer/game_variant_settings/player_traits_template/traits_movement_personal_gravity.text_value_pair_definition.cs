...
namespace TagTool.MtnDewIt.Commands.GenerateCache.Tags 
{
    public class multiplayer_game_variant_settings_player_traits_template_traits_movement_personal_gravity_text_value_pair_definition : TagFile
    {
        ...
        public override void TagData()
        {
            ...
            sily.Name = CacheContext.StringTable.GetOrAddString($@"traits_movement_gravity");
            sily.Description = CacheContext.StringTable.GetOrAddString($@"traits_movement_gravity_desc");
            sily.TextValuePairs = new List<TextValuePairDefinition.TextValuePair>
            {
                ...
                {
                    EnumeratedValue = 1,
                    Name = CacheContext.StringTable.GetOrAddString($@"percent_0"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_movement_gravity_less_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 2,
                ...
                new TextValuePairDefinition.TextValuePair
                {
                    ...
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_movement_gravity_normal_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 8,
                    Name = CacheContext.StringTable.GetOrAddString($@"percent_125"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_movement_gravity_more_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 9,
