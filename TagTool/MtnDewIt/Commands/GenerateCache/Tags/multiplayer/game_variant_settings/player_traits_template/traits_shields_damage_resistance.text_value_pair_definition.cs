...
namespace TagTool.MtnDewIt.Commands.GenerateCache.Tags 
{
    public class multiplayer_game_variant_settings_player_traits_template_traits_shields_damage_resistance_text_value_pair_definition : TagFile
    {
        ...
        public override void TagData()
        {
            ...
            sily.Name = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance");
            sily.Description = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_desc");
            sily.TextValuePairs = new List<TextValuePairDefinition.TextValuePair> 
            {
                ...
                new TextValuePairDefinition.TextValuePair
                {
                    ...
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_weaker_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 2,
                ...
                {
                    EnumeratedValue = 3,
                    Name = CacheContext.StringTable.GetOrAddString($@"percent_90"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_weaker_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 4,
                    Name = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_normal"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_normal_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 5,
                    Name = CacheContext.StringTable.GetOrAddString($@"percent_110"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_stronger_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 6,
                ...
                {
                    EnumeratedValue = 14,
                    Name = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_invulnerable"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_invulnerable_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 15,
                    Name = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_invincible"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_health_damage_resistance_invincible_desc"),
                },
            };
