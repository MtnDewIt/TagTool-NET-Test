...
namespace TagTool.MtnDewIt.Commands.GenerateCache.Tags 
{
    ...
    {
        public multiplayer_survival_mode_globals_survival_mode_globals(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<SurvivalModeGlobals>($@"multiplayer\survival_mode_globals");
