    ...
    partial class GenerateCacheCommand : Command
    {
        public void UpdateTagData()
        {
            using (var stream = Cache.OpenCacheReadWrite())
            {
                ...
                new ai_squad_templates_campaign_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_line_break_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_1_banshee_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_1_banshee_nobomb_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_1_chopper_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_1_ghost_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_1_hunter_flak_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_1_hunter_plasma_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_1_shade_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_2_banshee_nobomb_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_2_bodyguards_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_2_ghost_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_2_jackal_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_4_brute_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_4_cov_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_4_grunt_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_brute_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_brute_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_brute_stealth_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_brute_stealth_4_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_brute_stealth_6_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_brute_turret_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_bugger_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_bugger_4_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_bugger_pupa_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_bugger_pupa_4_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_cap_grunt_eng_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_captain_3_grunt_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_captain_brute_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_captain_brute_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_captain_engineer_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_captain_grunt_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_captain_jackal_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_captain_jackal_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_captain_solo_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_chieftain_flak_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_chieftain_hammer_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_chieftain_plasma_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_engineer_1_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_engineer_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_engineer_4_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_engineer_free_1_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_grunt_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_grunt_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_grunt_flak_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_grunt_flak_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_grunt_solo_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_grunt_turret_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_grunt_turret_undeployed_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_hunters_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_4_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_carbine_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_carbine_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_carbine_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_carbine_4_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_sniper_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_sniper_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_sniper_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_sniper_4_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jackal_solo_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jetpack_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jetpack_3_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jetpack_4_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_jetpack_solo_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_phantom_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_phantom_cheap_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_phantom_engineer_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_scorpion_2_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_scorpion_full_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_warthog_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_wraith_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_camp_wraith_aa_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_1_hunter_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_bonus_round_01_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_brute_jetpack_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_brute_pack_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_brute_stealth_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_bugger_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_bugger_day_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_chieftain_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_chieftain_1_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_chieftain_flak_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_chieftain_hammer_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_chieftain_plasma_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_covenant_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_grunt_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_jackal_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_jackal_sniper_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_phantom_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_sq_sur_phantom_cheap_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_survival_mode_squad_template(Cache, CacheContext, stream);

                new ai_squad_templates_vehicles_squad_template(Cache, CacheContext, stream);
                ...
                new globals_input_globals_input_globals(Cache, CacheContext, stream);
                ...
                new globals_rasterizer_globals_rasterizer_globals(Cache, CacheContext, stream);
                ...
                new multiplayer_survival_mode_globals_survival_mode_globals(Cache, CacheContext, stream);
                ...
                new objects_equipment_tripmine_tripmine_forge_equipment(Cache, CacheContext, stream);

                new objects_levels_multi_shrine_behemoth_behemoth_forge_vehicle(Cache, CacheContext, stream);

                new objects_vehicles_warthog_warthog_no_turret_vehicle(Cache, CacheContext, stream);

                new objects_vehicles_warthog_warthog_snow_gauss_vehicle(Cache, CacheContext, stream);

                new objects_vehicles_warthog_warthog_snow_no_turret_vehicle(Cache, CacheContext, stream);

                new objects_vehicles_warthog_warthog_snow_troop_vehicle(Cache, CacheContext, stream);

                new objects_vehicles_warthog_warthog_snow_wrecked_vehicle(Cache, CacheContext, stream);

                new objects_vehicles_warthog_warthog_troop_vehicle(Cache, CacheContext, stream);

                new objects_vehicles_warthog_warthog_wrecked_vehicle(Cache, CacheContext, stream);

                new objects_vehicles_wraith_wraith_anti_air_vehicle(Cache, CacheContext, stream);

                new sound_dsp_effects_sound_effect_templates_controller_0_headset_sound_effect_template(Cache, CacheContext, stream);

                new sound_dsp_effects_sound_effect_templates_controller_1_headset_sound_effect_template(Cache, CacheContext, stream);

                new sound_dsp_effects_sound_effect_templates_controller_2_headset_sound_effect_template(Cache, CacheContext, stream);

                new sound_dsp_effects_sound_effect_templates_controller_3_headset_sound_effect_template(Cache, CacheContext, stream);

                new sound_dsp_effects_sound_effect_templates_global_speaker_chorus_sound_effect_template(Cache, CacheContext, stream);

                new sound_dsp_effects_sound_effect_templates_mono_distortion_sound_effect_template(Cache, CacheContext, stream);

                new ui_chud_bitmaps_ballistic_meters_bitmap(Cache, CacheContext, stream);
