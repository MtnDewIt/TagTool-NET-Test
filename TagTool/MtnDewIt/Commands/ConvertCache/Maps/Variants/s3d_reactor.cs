            ...
            Blf blf = new Blf(Cache.Version, CachePlatform.Original)
            {
                ...
                MapVariantTagNames = new BlfMapVariantTagNames
                {
                    Names = new TagName[256]
                    {
                        ...
                        new TagName
                        {
                            Name = $@"objects\multi\ctf\ctf_flag_away_respawn_zone.scen",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\levels\multi\s3d_turf\turf_crate_large\turf_crate_large.bloc",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\gear\human\military\barricade_small\barricade_small.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\military\case\case.bloc",
                        },
                        new TagName
                        {
                        },
                        ...
                        Objects = new VariantObjectDatum[640]
                        {
                            ...
                            new VariantObjectDatum
                            {
                                ...
                                Properties = new VariantMultiplayerProperties
                                {
                                    ...
                                    SharedStorage = 0,
                                    SpawnTime = 5,
                                    Type = MultiplayerObjectType.Equipment,
                                    Boundary = new MultiplayerObjectBoundary
                                    {
                                        Type = MultiplayerObjectBoundaryShape.None,
                                        WidthRadius = 0f,
