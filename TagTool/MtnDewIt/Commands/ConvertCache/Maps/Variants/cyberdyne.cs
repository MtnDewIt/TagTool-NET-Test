            ...
            Blf blf = new Blf(Cache.Version, CachePlatform.Original)
            {
                ...
                MapVariantTagNames = new BlfMapVariantTagNames
                {
                    Names = new TagName[256]
                    {
                        new TagName
                        {
                            Name = $@"objects\levels\multi\cyberdyne\security_camera\security_camera.vehi",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\vehicles\warthog\warthog_troop.vehi",
                        },
                        new TagName
                        {
                            Name = $@"objects\vehicles\warthog\warthog_wrecked.vehi",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\gear\human\residential\office_table\office_table.scen",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\military\missle_stand\missle_stand.scen",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\levels\solo\020_base\monitor_sm\monitor_sm.scen",
                        },
                        new TagName
                        {
                            Name = $@"objects\levels\solo\020_base\sink\sink.scen",
                        },
                        new TagName
                        {
                            Name = $@"objects\levels\solo\020_base\armory_shelf\armory_shelf.scen",
                        },
                        new TagName
                        {
                            Name = $@"objects\levels\multi\cyberdyne\cyber_speaker\cyber_speaker.scen",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\gear\human\industrial\generator_heavy_kettle\generator_heavy_kettle.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\residential\office_keyboard\office_keyboard.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\residential\office_monitor\office_monitor.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\residential\office_file_tall\office_file_tall.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\residential\office_file_short\office_file_short.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\residential\office_chair\office_chair.bloc",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\gear\human\industrial\toolbox_small\toolbox_small.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\military\missle_cap\missle_cap.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\military\camping_stool_mp\camping_stool_mp.bloc",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\gear\human\residential\telephone_wall_box\telephone_wall_box.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\residential\h_locker_closed_mp\h_locker_closed_mp.bloc",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\gear\human\industrial\street_cone\street_cone.bloc",
                        },
                        new TagName
                        {
                        ...
                        new TagName
                        {
                            Name = $@"objects\gear\human\industrial\box_metal_small\box_metal_small.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\military\generator_light\generator_flood_no_lights.bloc",
                        },
                        new TagName
                        {
                            Name = $@"objects\gear\human\military\hu_mil_rucksack\rucksack.bloc",
                        },
                        new TagName
                        {
                    ...
                    MapVariant = new MapVariant
                    {
                        ...
                        Objects = new VariantObjectDatum[640]
                        {
                            ...
                            new VariantObjectDatum
                            {
                                ...
                                Properties = new VariantMultiplayerProperties
                                {
                                    EngineFlags = GameEngineSubTypeFlags.CaptureTheFlag | GameEngineSubTypeFlags.Slayer | GameEngineSubTypeFlags.Oddball | GameEngineSubTypeFlags.KingOfTheHill | GameEngineSubTypeFlags.Juggernaut | GameEngineSubTypeFlags.Territories | GameEngineSubTypeFlags.Assault | GameEngineSubTypeFlags.TargetTraining,
                                    Flags = VariantPlacementFlags.Symmetric | VariantPlacementFlags.Asymmetric,
                                    Team = MultiplayerTeamDesignator.Neutral,
                                    SharedStorage = 0,
                                    SpawnTime = 0,
