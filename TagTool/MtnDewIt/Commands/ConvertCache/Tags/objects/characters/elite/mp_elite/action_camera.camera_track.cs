...
{
    public class objects_characters_elite_mp_elite_action_camera_camera_track : TagFile
    {
        public objects_characters_elite_mp_elite_action_camera_camera_track(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<CameraTrack>($@"objects\characters\elite\mp_elite\action_camera");
