...
{
    public class objects_characters_elite_mp_elite_mp_elite_model : TagFile
    {
        public objects_characters_elite_mp_elite_mp_elite_model(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Model>($@"objects\characters\elite\mp_elite\mp_elite");
