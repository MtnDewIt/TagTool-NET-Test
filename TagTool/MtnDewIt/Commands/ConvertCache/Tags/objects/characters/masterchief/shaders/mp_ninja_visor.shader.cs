...
{
    public class objects_characters_masterchief_shaders_mp_ninja_visor_shader : TagFile
    {
        public objects_characters_masterchief_shaders_mp_ninja_visor_shader(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Shader>($@"objects\characters\masterchief\shaders\mp_ninja_visor");
