...
{
    public class objects_weapons_rifle_battle_rifle_battle_rifle_v3_battle_rifle_v3_weapon : TagFile
    {
        public objects_weapons_rifle_battle_rifle_battle_rifle_v3_battle_rifle_v3_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\battle_rifle\battle_rifle_v3\battle_rifle_v3");
