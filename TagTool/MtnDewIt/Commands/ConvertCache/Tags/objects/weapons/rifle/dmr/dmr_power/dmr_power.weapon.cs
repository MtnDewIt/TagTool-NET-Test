...
{
    public class objects_weapons_rifle_dmr_dmr_power_dmr_power_weapon : TagFile
    {
        public objects_weapons_rifle_dmr_dmr_power_dmr_power_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\dmr\dmr_power\dmr_power");
            ...
            weap.FirstPerson = new List<Weapon.FirstPersonBlock> 
            {
                ...
                {
                    FirstPersonModel = GetCachedTag<RenderModel>($@"objects\weapons\rifle\dmr\dmr_power\fp_dmr\fp_dmr_power"),
