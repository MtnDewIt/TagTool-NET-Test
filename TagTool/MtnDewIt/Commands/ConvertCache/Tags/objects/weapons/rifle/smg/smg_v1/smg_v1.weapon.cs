...
{
    public class objects_weapons_rifle_smg_smg_v1_smg_v1_weapon : TagFile
    {
        public objects_weapons_rifle_smg_smg_v1_smg_v1_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\smg\smg_v1\smg_v1");
