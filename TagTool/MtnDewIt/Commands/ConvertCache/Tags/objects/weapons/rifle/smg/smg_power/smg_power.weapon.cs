...
{
    public class objects_weapons_rifle_smg_smg_power_smg_power_weapon : TagFile
    {
        public objects_weapons_rifle_smg_smg_power_smg_power_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\smg\smg_power\smg_power");
            ...
            weap.FirstPerson = new List<Weapon.FirstPersonBlock> 
            {
                ...
                {
                    FirstPersonModel = GetCachedTag<RenderModel>($@"objects\weapons\rifle\smg\smg_power\fp_smg\fp_smg_power"),
