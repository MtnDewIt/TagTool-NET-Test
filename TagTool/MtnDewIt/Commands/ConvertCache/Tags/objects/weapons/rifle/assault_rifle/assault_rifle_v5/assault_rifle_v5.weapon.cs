...
{
    public class objects_weapons_rifle_assault_rifle_assault_rifle_v5_assault_rifle_v5_weapon : TagFile
    {
        public objects_weapons_rifle_assault_rifle_assault_rifle_v5_assault_rifle_v5_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\assault_rifle\assault_rifle_v5\assault_rifle_v5");
