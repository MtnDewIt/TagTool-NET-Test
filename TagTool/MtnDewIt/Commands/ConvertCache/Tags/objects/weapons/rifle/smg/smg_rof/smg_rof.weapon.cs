...
{
    public class objects_weapons_rifle_smg_smg_rof_smg_rof_weapon : TagFile
    {
        public objects_weapons_rifle_smg_smg_rof_smg_rof_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\smg\smg_rof\smg_rof");
            ...
            weap.FirstPerson = new List<Weapon.FirstPersonBlock> 
            {
                ...
                {
                    FirstPersonModel = GetCachedTag<RenderModel>($@"objects\weapons\rifle\smg\smg_rof\fp_smg\fp_smg_rof"),
