...
{
    public class objects_weapons_rifle_smg_smg_v6_smg_v6_weapon : TagFile
    {
        public objects_weapons_rifle_smg_smg_v6_smg_v6_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\smg\smg_v6\smg_v6");
