...
{
    public class objects_weapons_rifle_covenant_carbine_covenant_carbine_v6_covenant_carbine_v6_weapon : TagFile
    {
        public objects_weapons_rifle_covenant_carbine_covenant_carbine_v6_covenant_carbine_v6_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\covenant_carbine\covenant_carbine_v6\covenant_carbine_v6");
