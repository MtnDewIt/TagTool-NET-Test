...
{
    public class objects_weapons_rifle_battle_rifle_battle_rifle_v1_battle_rifle_v1_weapon : TagFile
    {
        public objects_weapons_rifle_battle_rifle_battle_rifle_v1_battle_rifle_v1_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\battle_rifle\battle_rifle_v1\battle_rifle_v1");
