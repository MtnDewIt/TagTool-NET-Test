...
{
    public class objects_weapons_rifle_beam_rifle_beam_rifle_weapon : TagFile
    {
        public objects_weapons_rifle_beam_rifle_beam_rifle_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
