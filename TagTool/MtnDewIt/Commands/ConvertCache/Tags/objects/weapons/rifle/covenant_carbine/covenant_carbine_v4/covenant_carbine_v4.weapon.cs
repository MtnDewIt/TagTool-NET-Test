...
{
    public class objects_weapons_rifle_covenant_carbine_covenant_carbine_v4_covenant_carbine_v4_weapon : TagFile
    {
        public objects_weapons_rifle_covenant_carbine_covenant_carbine_v4_covenant_carbine_v4_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\covenant_carbine\covenant_carbine_v4\covenant_carbine_v4");
