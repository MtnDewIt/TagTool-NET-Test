...
{
    public class objects_weapons_rifle_smg_smg_damage_smg_damage_weapon : TagFile
    {
        public objects_weapons_rifle_smg_smg_damage_smg_damage_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\smg\smg_damage\smg_damage");
            ...
            weap.FirstPerson = new List<Weapon.FirstPersonBlock> 
            {
                ...
                {
                    FirstPersonModel = GetCachedTag<RenderModel>($@"objects\weapons\rifle\smg\smg_damage\fp_smg\fp_smg_damage"),
