...
{
    public class objects_weapons_rifle_dmr_dmr_weapon : TagFile
    {
        public objects_weapons_rifle_dmr_dmr_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\dmr\dmr");
