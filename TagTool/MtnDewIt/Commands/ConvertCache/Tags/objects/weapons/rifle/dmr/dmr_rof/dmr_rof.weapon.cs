...
{
    public class objects_weapons_rifle_dmr_dmr_rof_dmr_rof_weapon : TagFile
    {
        public objects_weapons_rifle_dmr_dmr_rof_dmr_rof_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\dmr\dmr_rof\dmr_rof");
            ...
            weap.FirstPerson = new List<Weapon.FirstPersonBlock> 
            {
                ...
                {
                    FirstPersonModel = GetCachedTag<RenderModel>($@"objects\weapons\rifle\dmr\dmr_rof\fp_dmr\fp_dmr_rof"),
