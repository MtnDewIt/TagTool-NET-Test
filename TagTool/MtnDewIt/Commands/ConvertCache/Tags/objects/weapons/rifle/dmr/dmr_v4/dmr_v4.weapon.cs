...
{
    public class objects_weapons_rifle_dmr_dmr_v4_dmr_v4_weapon : TagFile
    {
        public objects_weapons_rifle_dmr_dmr_v4_dmr_v4_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\rifle\dmr\dmr_v4\dmr_v4");
