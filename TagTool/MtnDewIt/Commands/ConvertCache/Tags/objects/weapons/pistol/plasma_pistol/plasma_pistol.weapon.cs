...
{
    public class objects_weapons_pistol_plasma_pistol_plasma_pistol_weapon : TagFile
    {
        public objects_weapons_pistol_plasma_pistol_plasma_pistol_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\pistol\plasma_pistol\plasma_pistol");
