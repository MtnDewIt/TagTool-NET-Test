...
{
    public class objects_weapons_pistol_magnum_magnum_weapon : TagFile
    {
        public objects_weapons_pistol_magnum_magnum_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\pistol\magnum\magnum");
