...
{
    public class objects_weapons_multiplayer_flag_flag_weapon : TagFile
    {
        public objects_weapons_multiplayer_flag_flag_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\multiplayer\flag\flag");
