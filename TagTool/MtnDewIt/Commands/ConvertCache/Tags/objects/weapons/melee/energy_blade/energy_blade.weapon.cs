...
{
    public class objects_weapons_melee_energy_blade_energy_blade_weapon : TagFile
    {
        public objects_weapons_melee_energy_blade_energy_blade_weapon(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<Weapon>($@"objects\weapons\melee\energy_blade\energy_blade");
