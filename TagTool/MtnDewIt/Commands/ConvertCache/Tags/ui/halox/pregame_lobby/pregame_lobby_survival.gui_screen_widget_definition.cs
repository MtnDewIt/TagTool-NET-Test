...
{
    public class ui_halox_pregame_lobby_pregame_lobby_survival_gui_screen_widget_definition : TagFile
    {
        public ui_halox_pregame_lobby_pregame_lobby_survival_gui_screen_widget_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<GuiScreenWidgetDefinition>($@"ui\halox\pregame_lobby\pregame_lobby_survival");
