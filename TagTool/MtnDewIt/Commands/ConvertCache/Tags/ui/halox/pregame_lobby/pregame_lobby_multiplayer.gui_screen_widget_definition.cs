...
{
    public class ui_halox_pregame_lobby_pregame_lobby_multiplayer_gui_screen_widget_definition : TagFile
    {
        public ui_halox_pregame_lobby_pregame_lobby_multiplayer_gui_screen_widget_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<GuiScreenWidgetDefinition>($@"ui\halox\pregame_lobby\pregame_lobby_multiplayer");
            ...
            {
                Name = CacheContext.StringTable.GetOrAddString($@"pregame_lobby_multiplayer"),
            };
                        ...
                        TextWidgets = new List<TextWidget>
                        {
                            new TextWidget
                            {
                                Definition = new GuiTextWidgetDefinition
                                {
                                    ...
                                    GuiRenderBlock = new GuiDefinition
                                    {
                                        Name = CacheContext.StringTable.GetOrAddString($@"multiplayer_game_name"),
                                        Bounds720p = new Rectangle2d(656, 116, 715, 704),
                                        AnimationCollection = GetCachedTag<GuiWidgetAnimationCollectionDefinition>($@"ui\halox\main_menu\animations\lobby_slide"),
                                    },
                                    ValueIdentifier = CacheContext.StringTable.GetOrAddString($@"multiplayer_game_name"),
                        ...
                        BitmapWidgets = new List<BitmapWidget>
                        {
                            ...
                            new BitmapWidget
                            {
                                Definition = new GuiBitmapWidgetDefinition
                                {
                                    ...
                                    GuiRenderBlock = new GuiDefinition
                                    {
                                        Name = CacheContext.StringTable.GetOrAddString($@"gametype_image"),
