...
{
    public class ui_chud_multiplayer_intro_summary_slayer_chud_definition : TagFile
    {
        public ui_chud_multiplayer_intro_summary_slayer_chud_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<ChudDefinition>($@"ui\chud\multiplayer_intro\summary_slayer");
