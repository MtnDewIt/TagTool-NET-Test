...
{
    public class ui_chud_smg_power_chud_definition : TagFile
    {
        public ui_chud_smg_power_chud_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<ChudDefinition>($@"ui\chud\smg_power");
