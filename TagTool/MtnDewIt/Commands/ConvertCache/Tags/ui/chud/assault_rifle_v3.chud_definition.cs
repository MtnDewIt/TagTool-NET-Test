...
{
    public class ui_chud_assault_rifle_v3_chud_definition : TagFile
    {
        public ui_chud_assault_rifle_v3_chud_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<ChudDefinition>($@"ui\chud\assault_rifle_v3");
