...
namespace TagTool.MtnDewIt.Commands.ConvertCache.Tags 
{
    public class multiplayer_game_variant_settings_player_traits_template_traits_appearance_active_camo_text_value_pair_definition : TagFile
    {
        ...
        public override void TagData()
        {
            ...
            sily.Name = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo");
            sily.Description = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_desc");
            sily.TextValuePairs = new List<TextValuePairDefinition.TextValuePair>
            {
                ...
                {
                    EnumeratedValue = 1,
                    Name = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_off"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_off_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 2,
                    Name = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_bad"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_bad_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 3,
                    Name = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_poor"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_poor_desc"),
                },
                new TextValuePairDefinition.TextValuePair
                {
                    EnumeratedValue = 4,
                    Name = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_good"),
                    Description = CacheContext.StringTable.GetOrAddString($@"traits_appearance_active_camo_good_desc"),
                },
            };
