...
{
    public class multiplayer_game_variant_settings_map_overrides_traits_weapons_initial_secondary_untemplated_text_value_pair_definition : TagFile
    {
        public multiplayer_game_variant_settings_map_overrides_traits_weapons_initial_secondary_untemplated_text_value_pair_definition(GameCache cache, GameCacheHaloOnline cacheContext, Stream stream) : base
        (
            cache,
            cacheContext,
            stream
        ...
        {
            var tag = GetCachedTag<TextValuePairDefinition>($@"multiplayer\game_variant_settings\map_overrides\traits_weapons_initial_secondary_untemplated");
            ...
            sily.Name = CacheContext.StringTable.GetOrAddString($@"traits_weapons_initial_secondary");
            sily.Description = CacheContext.StringTable.GetOrAddString($@"traits_weapons_initial_secondary_desc");
