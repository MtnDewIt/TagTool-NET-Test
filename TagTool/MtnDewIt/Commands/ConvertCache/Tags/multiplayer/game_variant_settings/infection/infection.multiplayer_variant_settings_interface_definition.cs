    ...
    public class multiplayer_game_variant_settings_infection_infection_multiplayer_variant_settings_interface_definition : TagFile
    {
        ...
        public override void TagData()
        {
            ...
            goof.GameEngineSettings = new List<MultiplayerVariantSettingsInterfaceDefinition.GameEngineSetting>
            {
                ...
                {
                    Name = CacheContext.StringTable.GetOrAddString($@"infection"),
                    ...
                    Options = new List<MultiplayerVariantSettingsInterfaceDefinition.GameEngineSetting.Option>
                    {
                        new MultiplayerVariantSettingsInterfaceDefinition.GameEngineSetting.Option
                        {
                            ...
                            SubmenuName = CacheContext.StringTable.GetOrAddString($@"infection_scoring"),
                            SubmenuDescription = CacheContext.StringTable.GetOrAddString($@"infection_scoring_desc"),
                        },
                        new MultiplayerVariantSettingsInterfaceDefinition.GameEngineSetting.Option
                        {
                            ...
                            SubmenuName = CacheContext.StringTable.GetOrAddString($@"infection_traits_zombie"),
                            SubmenuDescription = CacheContext.StringTable.GetOrAddString($@"infection_traits_zombie_desc"),
                        },
                        new MultiplayerVariantSettingsInterfaceDefinition.GameEngineSetting.Option
                        {
                            TemplateBasedSubmenu = GetCachedTag<MultiplayerVariantSettingsInterfaceDefinition>($@"multiplayer\game_variant_settings\player_traits_template\player_traits_template"),
                            ...
                            SubmenuName = CacheContext.StringTable.GetOrAddString($@"infection_traits_alpha"),
                            SubmenuDescription = CacheContext.StringTable.GetOrAddString($@"infection_traits_alpha_desc"),
                        },
                        new MultiplayerVariantSettingsInterfaceDefinition.GameEngineSetting.Option
                        {
                            ...
                            SubmenuName = CacheContext.StringTable.GetOrAddString($@"infection_traits_last_man"),
                            SubmenuDescription = CacheContext.StringTable.GetOrAddString($@"infection_traits_last_man_desc"),
                        },
                        new MultiplayerVariantSettingsInterfaceDefinition.GameEngineSetting.Option
                        {
                        ...
                        new MultiplayerVariantSettingsInterfaceDefinition.GameEngineSetting.Option
                        {
                            ...
                            SubmenuName = CacheContext.StringTable.GetOrAddString($@"infection_traits_safe_haven"),
                            SubmenuDescription = CacheContext.StringTable.GetOrAddString($@"infection_traits_safe_haven_desc"),
                        },
                    },
                },
            };
