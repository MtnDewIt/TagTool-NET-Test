...
namespace TagTool.MtnDewIt.Porting
{
    public partial class PortingContext
	{
        ...
        private bool TagIsValid(CachedTag blamTag, Stream blamCacheStream, out CachedTag resultTag)
        {
            ...
            if (TagConstants.ResourceTagGroups.Contains(blamTag.Group.Tag))
            {
                ...
                if (blamTag.Group.Tag == "snd!")
                {
                    ...
                    if (BlamSoundGestalt == null)
                        BlamSoundGestalt = LoadSoundGestalt(BlamCache, blamCacheStream);
        ...
        public CachedTag ConvertTagInternal(Stream cacheStream, Stream blamCacheStream, Dictionary<ResourceLocation, Stream> resourceStreams, CachedTag blamTag)
		{
			...
			switch (groupTag.ToString())
			{
                case "snd!":
                    ...
                    {
                        TagConstants.DefaultTagNames.TryGetValue(groupTag, out string defaultSoundName);
                ...
                case "udlg":
                    ...
                    {
                        TagConstants.DefaultTagNames.TryGetValue(groupTag, out string defaultUdlgName);
            ...
            foreach (var instance in CacheContext.TagCache.TagTable)
            {
                ...
                {
                    if (FlagIsSet(PortingFlags.Replace) && !TagConstants.DoNotReplaceGroups.Contains(instance.Group.Tag.ToString()) 
