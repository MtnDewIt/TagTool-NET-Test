...
using System.IO;
using TagTool.MtnDewIt.Shaders.ShaderMatching;
using System;
using TagTool.MtnDewIt.Shaders.ShaderConverter;
...
namespace TagTool.MtnDewIt.Porting
{
    partial class PortingContext
    {
        ...
        public InlineShaderMatcher Matcher = new InlineShaderMatcher();
        ...
        {
            InlineShaderConverter shaderConverter = new InlineShaderConverter(CacheContext, 
                BlamCache, 
                cacheStream, 
                blamCacheStream,
                finalRm, 
