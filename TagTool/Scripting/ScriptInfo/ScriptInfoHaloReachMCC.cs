...
{
    public class ScriptInfoHaloReachMCC
    {
        ...
        public static Dictionary<int, string> Globals = new Dictionary<int, string>
        {
            ...
            [0x17] = "terminal_render",
            [0x18] = "events_debug_spam_render",
            [0x19] = "console_dump_to_debug_display",
            [0x1A] = "camera_fov",
            [0x1B] = "camera_yaw_scale",
            [0x1C] = "camera_pitch_scale",
            [0x1D] = "camera_forward_scale",
            [0x1E] = "camera_side_scale",
            [0x1F] = "camera_up_scale",
            [0x20] = "flying_camera_maximum_boost_speed",
            [0x21] = "flying_camera_movement_delay",
            [0x22] = "flying_camera_has_collision",
            [0x23] = "flying_camera_use_old_controls",
            [0x24] = "editor_director_mouse_wheel_speed_enabled",
            [0x25] = "CameraObserverAllowNonrecorderFirstPerson",
            [0x26] = "async_display_statistics",
            [0x27] = "suppress_upload_debug",
            [0x28] = "lightmap_pointsample",
            [0x29] = "debug_no_frustum_clip",
            [0x2A] = "debug_camera_projection",
            [0x2B] = "debug_bink",
            [0x2C] = "game_paused",
            [0x2D] = "game_speed",
            [0x2E] = "game_time_lock",
            ...
            [0xBD] = "sound_direct_path_gain",
            [0xBE] = "sound_reverb_path_gain",
            [0xBF] = "sound_reverb_wet_dry_mix",
            [0xC0] = "enable_pc_sound",
            [0xC1] = "debug_sound",
            [0xC2] = "debug_looping_sound",
            [0xC3] = "debug_sound_channels",
            [0xC4] = "debug_sound_channels_fadeout",
            [0xC5] = "debug_sound_spatialized",
            [0xC6] = "debug_sound_spatialized_fadeout",
            [0xC7] = "debug_platform_sound_channels",
            [0xC8] = "debug_sound_reverb",
            [0xC9] = "sound_cache_list",
            [0xCA] = "debug_speaker_output_peak",
            [0xCB] = "debug_speaker_output_rms",
            [0xCC] = "debug_display_levels_data",
            [0xCD] = "debug_display_preformance_data",
            [0xCE] = "debug_display_sources_data_state",
            [0xCF] = "debug_display_sources_data",
            [0xD0] = "debug_display_mix_data",
            [0xD1] = "debug_display_reverb_data",
            [0xD2] = "debug_sound_mute_effect_final_mix",
            [0xD3] = "debug_sound_mute_effect_sub_mix",
            [0xD4] = "debug_sound_mute_effect_occlusion",
            [0xD5] = "debug_sound_mute_effect_obstruction",
            [0xD6] = "debug_sound_mute_effect_radio",
            [0xD7] = "debug_sound_mute_effect_reverb_first",
            [0xD8] = "debug_sound_mute_effect_reverb_second",
            [0xD9] = "debug_sound_mute_music",
            [0xDA] = "debug_sound_mute_dialog",
            [0xDB] = "debug_sound_mute_ambient",
            [0xDC] = "debug_sound_mute_vehicles",
            [0xDD] = "debug_sound_mute_weapons",
            [0xDE] = "debug_sound_mute_mix_dry",
            [0xDF] = "debug_sound_mute_mix_dry_obstruction",
            [0xE0] = "debug_sound_mute_mix_wet",
            [0xE1] = "debug_sound_mute_mix_wet_occlusion",
            [0xE2] = "debug_sound_mute_mix_radio",
            [0xE3] = "debug_duckers",
            [0xE4] = "debug_sound_listeners",
            [0xE5] = "debug_disable_music_channel",
            [0xE6] = "debug_disable_dialog_channel",
            [0xE7] = "debug_disable_cinematic_channel",
            [0xE8] = "debug_disable_ambiant_channel",
            [0xE9] = "debug_disable_vehicle_channel",
            [0xEA] = "debug_disable_weapon_channel",
            [0xEB] = "debug_disable_other_channel",
            [0xEC] = "debug_disable_looping_channels",
            [0xED] = "debug_disable_nonlooping_channels",
            [0xEE] = "debug_sound_force_first_person_listener",
            [0xEF] = "debug_sound_reference_counts",
            [0xF0] = "debug_sound_environment_parameters",
            [0xF1] = "debug_sound_channel_overflow",
            [0xF2] = "debug_sound_impulse_time",
            [0xF3] = "debug_sound_impulse_spam",
            [0xF4] = "debug_sound_stabbed",
            [0xF5] = "sound_enable_expensive_obstruction",
            [0xF6] = "sound_enable_new_obstruction_collision",
            [0xF7] = "debug_sound_enable_multithreaded",
            [0xF8] = "debug_acoustics",
            [0xF9] = "light_local_basis",
            [0xFA] = "collision_log_render",
            [0xFB] = "collision_log_detailed",
            [0xFC] = "collision_log_extended",
            [0xFD] = "collision_log_totals_only",
            [0xFE] = "collision_log_time",
            [0xFF] = "havok_collision_tolerance",
