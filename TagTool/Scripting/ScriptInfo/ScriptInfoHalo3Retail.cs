...
{
    public class ScriptInfoHalo3Retail
    {
        ...
        public static Dictionary<int, string> Globals = new Dictionary<int, string>
        {
            ...
            [0x5D] = "unknown5D",
            [0x5E] = "unknown5E",
            [0x5F] = "effects_corpse_nonviolent",
            [0x60] = "unknown60",
            [0x61] = "unknown61",
            [0x62] = "unknown62",
            [0x63] = "unknown63",
            ...
            [0x79] = "unknown79",
            [0x7A] = "unknown7A",
            [0x7B] = "use_dynamic_object_obstruction",
            [0x7C] = "unknown7C",
            [0x7D] = "unknown7D",
            [0x7E] = "unknown7E",
            [0x7F] = "unknown7F",
            ...
            [0x99] = "unknown99",
            [0x9A] = "unknown9A",
            [0x9B] = "disable_expensive_physics_rebuilding",
            [0x9C] = "minimum_havok_object_acceleration",
            [0x9D] = "minimum_havok_biped_object_acceleration",
            [0x9E] = "unknown9E",
            [0x9F] = "unknown9F",
            [0xA0] = "unknownA0",
            [0xA1] = "unknownA1",
            ...
            [0xC5] = "unknownC5",
            [0xC6] = "unknownC6",
            [0xC7] = "render_screen_flashes",
            [0xC8] = "texture_camera_near_plane",
            [0xC9] = "texture_camera_exposure",
            [0xCA] = "texture_camera_illum_scale",
            [0xCB] = "render_near_clip_distance",
            [0xCC] = "render_far_clip_distance",
            [0xCD] = "unknownCD",
            [0xCE] = "unknownCE",
            [0xCF] = "render_HDR_target_stops",
            [0xD0] = "render_surface_LDR_mode",
            [0xD1] = "render_surface_HDR_mode",
            [0xD2] = "render_first_person_fov_scale",
            [0xD3] = "rasterizer_triliner_threshold",
            [0xD4] = "rasterizer_present_immediate_threshold",
            [0xD5] = "tiling",
            [0xD6] = "render_screen_res",
            [0xD7] = "render_force_tiling",
            [0xD8] = "render_tiling_resolve_fragment_index",
            [0xD9] = "render_tiling_viewport_offset_x",
            [0xDA] = "render_tiling_viewport_offset_y",
            [0xDB] = "render_true_gamma",
            [0xDC] = "unknownDC",
            [0xDD] = "unknownDD",
            [0xDE] = "unknownDE",
            [0xDF] = "unknownDF",
            ...
            [0xF7] = "unknownF7",
            [0xF8] = "render_bounce_light_intensity",
            [0xF9] = "render_bounce_light_only",
            [0xFA] = "unknownFA",
            [0xFB] = "unknownFB",
            [0xFC] = "unknownFC",
            [0xFD] = "unknownFD",
