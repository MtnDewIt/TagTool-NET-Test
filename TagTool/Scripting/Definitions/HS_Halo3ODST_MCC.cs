...
{
    public class HS_Halo3ODST_MCC : IScriptDefinitions
    {
        ...
        public static readonly IReadOnlyDictionary<int, string> Globals = new Dictionary<int, string>()
        {
            ...
            [0x02E] = "output_bad_pda_model_info",
            [0x02F] = "prune_global_use_empty",
            [0x030] = "prune_scenario_material_effects",
            [0x031] = "prune_scenario_lightmaps",
            [0x032] = "prune_scenario_add_single_bsp_zones",
            [0x033] = "prune_scenario_force_single_bsp_zone_set",
            [0x034] = "prune_scenario_for_environment_editing",
            [0x035] = "prune_scenario_force_solo_mode",
            [0x036] = "prune_scenario_for_environment_editing_keep_cinematics",
            [0x037] = "prune_scenario_use_gray_shader",
            [0x038] = "prune_global_dialog_sounds",
            [0x039] = "prune_global",
            [0x03A] = "prune_global_keep_playable",
            [0x03B] = "prune_error_geometry",
            [0x03C] = "debug_structure_sampling",
            [0x03D] = "display_precache_progress",
            [0x03E] = "debug_object_garbage_collection",
            [0x03F] = "debug_object_dump_log",
            [0x040] = "allow_all_sounds_on_player",
            [0x041] = "disable_player_rotation",
            [0x042] = "player_rotation_scale",
            [0x043] = "debug_player_respawn",
            [0x044] = "g_synchronous_client_maximum_catchup_chunk_size",
            [0x045] = "g_editor_maximum_edited_object_speed",
            [0x046] = "g_editor_edited_object_spring_constant",
            [0x047] = "g_editor_maximum_rotation_speed",
            [0x048] = "chud_enabled",
            [0x049] = "chud_debug_grid",
            [0x04A] = "chud_debug_messages",
            [0x04B] = "chud_cortana_debug",
            [0x04C] = "chud_debug_crosshair",
            [0x04D] = "chud_debug_metagame",
            [0x04E] = "debug_unit_all_animations",
            [0x04F] = "debug_unit_animations",
            [0x050] = "debug_unit_illumination",
            [0x051] = "debug_unit_active_camo_frequency_modulator",
            [0x052] = "debug_unit_active_camo_frequency_modulator_bias",
            [0x053] = "debug_player_melee_attack",
            [0x054] = "debug_boarding_force_enemy",
            [0x055] = "enable_animation_influenced_flight",
            [0x056] = "enable_flight_noise",
            [0x057] = "enable_player_transitions",
            [0x058] = "disable_node_interpolation",
            [0x059] = "disable_analog_movement",
            [0x05A] = "disable_transition_animations",
            [0x05B] = "cheat_deathless_player",
            [0x05C] = "cheat_valhalla",
            [0x05D] = "cheat_jetpack",
            [0x05E] = "cheat_infinite_ammo",
            [0x05F] = "cheat_bottomless_clip",
            [0x060] = "cheat_bump_possession",
            [0x061] = "cheat_super_jump",
            [0x062] = "cheat_reflexive_damage_effects",
            [0x063] = "cheat_medusa",
            [0x064] = "cheat_omnipotent",
            [0x065] = "cheat_controller",
            [0x066] = "cheat_chevy",
            [0x067] = "effects_corpse_nonviolent",
            [0x068] = "debug_effects_nonviolent",
            [0x069] = "debug_effects_locations",
            [0x06A] = "effects_enable",
            [0x06B] = "debug_effects_allocation",
            [0x06C] = "debug_effects_play_distances",
            [0x06D] = "debug_effects_lightprobe_sampling",
            [0x06E] = "player_effects_enabled",
            [0x06F] = "g_animation_statistic_accumulator_enabled",
            [0x070] = "sound_global_room_gain",
            [0x071] = "sound_direct_path_gain",
            [0x072] = "enable_pc_sound",
            [0x073] = "debug_sound_cache",
            [0x074] = "debug_sound_cache_status",
            [0x075] = "debug_sound_manager_channels",
            [0x076] = "debug_sound_manager_channels_status",
            [0x077] = "debug_sound",
            [0x078] = "debug_looping_sound",
            [0x079] = "debug_game_sound",
            [0x07A] = "debug_sound_channels",
            [0x07B] = "debug_sound_channels_fadeout",
            [0x07C] = "debug_platform_sound_channels",
            [0x07D] = "debug_sound_reverb",
            [0x07E] = "sound_cache_graph",
            [0x07F] = "debug_speaker_output_peak",
            [0x080] = "debug_speaker_output_rms",
            [0x081] = "debug_display_levels_data",
            [0x082] = "debug_display_preformance_data",
            [0x083] = "debug_display_sources_data_state",
            [0x084] = "debug_display_sources_data",
            [0x085] = "debug_display_mix_data",
            [0x086] = "debug_sound_mute_effect_final_mix",
            [0x087] = "debug_sound_mute_effect_sub_mix",
            [0x088] = "debug_sound_mute_effect_occlusion",
            [0x089] = "debug_sound_mute_effect_obstruction",
            [0x08A] = "debug_sound_mute_effect_radio",
            [0x08B] = "debug_sound_mute_effect_reverb_first",
            [0x08C] = "debug_sound_mute_effect_reverb_second",
            [0x08D] = "debug_sound_mute_music",
            [0x08E] = "debug_sound_mute_dialog",
            [0x08F] = "debug_sound_mute_ambient",
            [0x090] = "debug_sound_mute_vehicles",
            [0x091] = "debug_sound_mute_weapons",
            [0x092] = "debug_sound_mute_mix_dry",
            [0x093] = "debug_sound_mute_mix_dry_obstruction",
            [0x094] = "debug_sound_mute_mix_wet",
            [0x095] = "debug_sound_mute_mix_wet_occlusion",
            [0x096] = "debug_sound_mute_mix_radio",
            [0x097] = "debug_sound_timing",
            [0x098] = "debug_duckers",
            [0x099] = "debug_sound_listeners",
            [0x09A] = "debug_sound_force_first_person_listener",
            [0x09B] = "debug_disable_music_channel",
            [0x09C] = "debug_disable_dialog_channel",
            [0x09D] = "debug_disable_cinematic_channel",
            [0x09E] = "debug_disable_ambiant_channel",
            [0x09F] = "debug_disable_vehicle_channel",
            [0x0A0] = "debug_disable_weapon_channel",
            [0x0A1] = "debug_disable_other_channel",
            [0x0A2] = "debug_disable_looping_channels",
            [0x0A3] = "debug_disable_nonlooping_channels",
            [0x0A4] = "debug_sound_reference_counts",
            [0x0A5] = "background_sound_meter_display",
            [0x0A6] = "debug_sound_environment_parameters",
            [0x0A7] = "debug_sound_channel_overflow",
            [0x0A8] = "debug_sound_impulse_time",
            [0x0A9] = "debug_sound_impulse_spam",
            [0x0AA] = "use_dynamic_object_obstruction",
            [0x0AB] = "debug_sound_stabbed",
            [0x0AC] = "debug_sound_environment",
            [0x0AD] = "light_local_basis",
            [0x0AE] = "collision_log_render",
            [0x0AF] = "collision_log_detailed",
            [0x0B0] = "collision_log_extended",
            [0x0B1] = "collision_log_totals_only",
            [0x0B2] = "collision_log_time",
            [0x0B3] = "havok_collision_tolerance",
            [0x0B4] = "havok_debug_mode",
            [0x0B5] = "havok_thread_count",
            [0x0B6] = "havok_environment_type",
            [0x0B7] = "havok_shape_radius",
            [0x0B8] = "havok_jumping_beans",
            [0x0B9] = "havok_disable_deactivation",
            [0x0BA] = "havok_weld_environment",
            [0x0BB] = "havok_batch_add_entities_disabled",
            [0x0BC] = "havok_shape_cache",
            [0x0BD] = "havok_shape_cache_debug",
            [0x0BE] = "havok_enable_back_stepping",
            [0x0BF] = "havok_enable_sweep_shapes",
            [0x0C0] = "havok_display_stats",
            [0x0C1] = "havok_initialize_profiling",
            [0x0C2] = "impacts_debug",
            [0x0C3] = "proxies_debug",
            [0x0C4] = "collision_damage_debug",
            [0x0C5] = "havok_play_impact_effects",
            [0x0C6] = "havok_play_biped_impact_effects",
            [0x0C7] = "physics_debug",
            [0x0C8] = "havok_cleanup_inactive_agents",
            [0x0C9] = "havok_memory_always_system",
            [0x0CA] = "disable_expensive_physics_rebuilding",
            [0x0CB] = "minimum_havok_object_acceleration",
            [0x0CC] = "minimum_havok_biped_object_acceleration",
            [0x0CD] = "debug_object_scheduler",
            [0x0CE] = "render_debug_cache_state",
            [0x0CF] = "render_environment",
            [0x0D0] = "render_objects",
            [0x0D1] = "visibility_debug_use_old_sphere_test",
            [0x0D2] = "render_lightmap_shadows",
            [0x0D3] = "render_lightmap_shadows_apply",
            [0x0D4] = "render_lights",
            [0x0D5] = "render_water_tessellated",
            [0x0D6] = "render_water_wireframe",
            [0x0D7] = "render_water_interaction",
            [0x0D8] = "render_water",
            [0x0D9] = "render_water_ripple_cutoff_distance",
            [0x0DA] = "render_first_person",
            [0x0DB] = "render_debug_mode",
            [0x0DC] = "render_debug_safe_frame_bounds",
            [0x0DD] = "render_debug_colorbars",
            [0x0DE] = "render_debug_aspect_ratio_scale",
            [0x0DF] = "render_debug_force_4x3_aspect_ratio",
            [0x0E0] = "render_debug_transparents",
            [0x0E1] = "render_debug_slow_transparents",
            [0x0E2] = "render_transparents",
            [0x0E3] = "render_debug_transparent_cull",
            [0x0E4] = "render_debug_transparent_cull_flip",
            [0x0E5] = "render_debug_transparent_sort_method",
            [0x0E6] = "render_debug_lens_flares",
            [0x0E7] = "render_instanced_geometry",
            [0x0E8] = "render_sky",
            [0x0E9] = "render_lens_flares",
            [0x0EA] = "render_decorators",
            [0x0EB] = "light_decorators",
            [0x0EC] = "render_decorator_bounds",
            [0x0ED] = "render_decorator_spheres",
            [0x0EE] = "render_decorator_bsp_test_offset_scale_parameter",
            [0x0EF] = "render_muffins",
            [0x0F0] = "render_debug_muffins",
            [0x0F1] = "render_debug_force_cinematic_lights",
            [0x0F2] = "render_debug_pix_events",
            [0x0F3] = "render_atmosphere_cluster_blend_data",
            [0x0F4] = "render_debug_display_command_buffer_data",
            [0x0F5] = "render_debug_screen_shaders",
            [0x0F6] = "render_debug_screen_effects",
            [0x0F7] = "render_screen_effects",
            [0x0F8] = "render_pc_specular",
            [0x0F9] = "render_pc_albedo_lighting",
            [0x0FA] = "render_debug_save_surface",
            [0x0FB] = "render_disable_screen_effects_not_first_person",
            [0x0FC] = "render_screen_flashes",
            [0x0FD] = "texture_camera_near_plane",
            [0x0FE] = "texture_camera_exposure",
            [0x0FF] = "texture_camera_illum_scale",
