...
namespace TagTool.Scripting.Definitions
{
    public class HS_Halo3ODST : IScriptDefinitions
    {
        ...
        public static readonly IReadOnlyDictionary<int, string> Globals = new Dictionary<int, string>()
        {
            ...
            [0x06F] = "unknown6F",
            [0x070] = "unknown70",
            [0x071] = "effects_corpse_nonviolent",
            [0x072] = "unknown72",
            [0x073] = "unknown73",
            [0x074] = "unknown74",
            [0x075] = "unknown75",
            ...
            [0x08E] = "unknown8E",
            [0x08F] = "unknown8F",
            [0x090] = "use_dynamic_object_obstruction",
            [0x091] = "unknown91",
            [0x092] = "unknown92",
            [0x093] = "unknown93",
            [0x094] = "unknown94",
            ...
            [0x0AE] = "unknownAE",
            [0x0AF] = "unknownAF",
            [0x0B0] = "disable_expensive_physics_rebuilding",
            [0x0B1] = "minimum_havok_object_acceleration",
            [0x0B2] = "minimum_havok_biped_object_acceleration",
            [0x0B3] = "unknownB3",
            [0x0B4] = "unknownB4",
            [0x0B5] = "unknownB5",
            [0x0B6] = "unknownB6",
            ...
            [0x0BD] = "unknownBD",
            [0x0BE] = "unknownBE",
            [0x0BF] = "render_water_ripple_cutoff_distance",
            [0x0C0] = "unknownC0",
            [0x0C1] = "unknownC1",
            [0x0C2] = "unknownC2",
            [0x0C3] = "unknownC3",
            ...
            [0x0E0] = "unknownE0",
            [0x0E1] = "unknownE1",
            [0x0E2] = "render_screen_flashes",
            [0x0E3] = "texture_camera_near_plane",
            [0x0E4] = "texture_camera_exposure",
            [0x0E5] = "texture_camera_illum_scale",
            [0x0E6] = "render_near_clip_distance",
            [0x0E7] = "render_far_clip_distance",
            [0x0E8] = "unknownE8",
            [0x0E9] = "unknownE9",
            [0x0EA] = "render_HDR_target_stops",
            [0x0EB] = "render_surface_LDR_mode",
            [0x0EC] = "render_surface_HDR_mode",
            [0x0ED] = "render_first_person_fov_scale",
            [0x0EE] = "rasterizer_triliner_threshold",
            [0x0EF] = "rasterizer_present_immediate_threshold",
            [0x0F0] = "tiling",
            [0x0F1] = "render_screen_res",
            [0x0F2] = "render_force_tiling",
            [0x0F3] = "render_tiling_resolve_fragment_index",
            [0x0F4] = "render_tiling_viewport_offset_x",
            [0x0F5] = "render_tiling_viewport_offset_y",
            [0x0F6] = "render_true_gamma",
            [0x0F7] = "unknownF7",
            [0x0F8] = "unknownF8",
            [0x0F9] = "unknownF9",
            [0x0FA] = "unknownFA",
        ...
        public static readonly IReadOnlyDictionary<int, ScriptInfo> Scripts = new Dictionary<int, ScriptInfo>()
        {
            ...
            [0x68E] = new ScriptInfo(HsType.HaloOnlineValue.Void, "clear_map_slot")
            {
                new ScriptInfo.ParameterInfo(HsType.HaloOnlineValue.Long),
            },
            [0x68F] = new ScriptInfo(HsType.HaloOnlineValue.Void, "clear_map_type")
            {
                new ScriptInfo.ParameterInfo(HsType.HaloOnlineValue.Long),
            },
