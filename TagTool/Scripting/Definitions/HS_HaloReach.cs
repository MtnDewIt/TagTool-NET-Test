...
{
    public class HS_HaloReach : IScriptDefinitions
    {
        ...
        public static readonly IReadOnlyDictionary<int, string> Globals = new Dictionary<int, string>()
        {
            ...
            [0x0F4] = "unknownF4",
            [0x0F5] = "unknownF5",
            [0x0F6] = "disable_expensive_physics_rebuilding",
            [0x0F7] = "minimum_havok_object_acceleration",
            [0x0F8] = "minimum_havok_biped_object_acceleration",
            [0x0F9] = "debug_object_scheduler",
            [0x0FA] = "render_debug_turn_on_cache_state",
            [0x0FB] = "debug_use_black_for_missing_instances",
            [0x0FC] = "render_environment",
            [0x0FD] = "render_structure",
            [0x0FE] = "render_per_vertex_lit_environment",
            [0x0FF] = "render_per_pixel_lit_enviroment",
        ...
        public static readonly IReadOnlyDictionary<int, ScriptInfo> Scripts = new Dictionary<int, ScriptInfo>()
        {
            ...
            [0x039] = new ScriptInfo(HsType.HaloOnlineValue.Unit, "player_in_game_get")
            {
                new ScriptInfo.ParameterInfo(HsType.HaloOnlineValue.Long),
            },

            //[0x03A] = new ScriptInfo(HsType.HaloOnlineValue.player, "human_player_in_game_get")
            [0x03A] = new ScriptInfo(HsType.HaloOnlineValue.Unit, "human_player_in_game_get")
            {
                new ScriptInfo.ParameterInfo(HsType.HaloOnlineValue.Long),
            },

            //[0x03B] = new ScriptInfo(HsType.HaloOnlineValue.player, "elite_player_in_game_get")
            [0x03B] = new ScriptInfo(HsType.HaloOnlineValue.Unit, "elite_player_in_game_get")
            {
                new ScriptInfo.ParameterInfo(HsType.HaloOnlineValue.Long),
            },
