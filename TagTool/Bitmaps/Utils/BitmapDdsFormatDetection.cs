...
namespace TagTool.Bitmaps
{
    public static class BitmapDdsFormatDetection
    {
        ...
        private class BitmapFormatDefinition
        {
            ...
            public override bool Equals(object obj)
            {
                ...
                return (BitsPerPixel == other.BitsPerPixel &&
                        ...
                        ABitMask == other.ABitMask && FourCc == other.FourCc);
            }
        ...
        private static readonly Dictionary<BitmapFormat, BitmapFormatDefinition> ExtractionDefinitions = new Dictionary<BitmapFormat, BitmapFormatDefinition>
        {
            { BitmapFormat.A8,            new BitmapFormatDefinition { BitsPerPixel = 8, ABitMask = 0xFF } },
            { BitmapFormat.Y8,            new BitmapFormatDefinition { BitsPerPixel = 8, RBitMask = 0xFF } },
            { BitmapFormat.AY8,           new BitmapFormatDefinition { BitsPerPixel = 8, ABitMask = 0xFF } },
            { BitmapFormat.A8Y8,          new BitmapFormatDefinition { BitsPerPixel = 16, ABitMask = 0xFF00, RBitMask = 0x00FF } },
            { BitmapFormat.R5G6B5,        new BitmapFormatDefinition { BitsPerPixel = 16, RBitMask = 0xF800, GBitMask = 0x07E0, BBitMask = 0x001F } },
            { BitmapFormat.A1R5G5B5,      new BitmapFormatDefinition { BitsPerPixel = 16, ABitMask = 0x8000, RBitMask = 0x7C00, GBitMask = 0x03E0, BBitMask = 0x001F } },
            { BitmapFormat.A4R4G4B4,      new BitmapFormatDefinition { BitsPerPixel = 16, ABitMask = 0xF000, RBitMask = 0x0F00, GBitMask = 0x00F0, BBitMask = 0x000F } },
            { BitmapFormat.X8R8G8B8,      new BitmapFormatDefinition { BitsPerPixel = 32, RBitMask = 0x00FF0000, GBitMask = 0x0000FF00, BBitMask = 0x000000FF } },
            { BitmapFormat.A8R8G8B8,      new BitmapFormatDefinition { BitsPerPixel = 32, ABitMask = 0xFF000000, RBitMask = 0x00FF0000, GBitMask = 0x0000FF00, BBitMask = 0x000000FF } },
            { BitmapFormat.Dxt1,          new BitmapFormatDefinition { FourCc = DDSFourCC.FromString("DXT1") } },
            { BitmapFormat.Dxt3,          new BitmapFormatDefinition { FourCc = DDSFourCC.FromString("DXT3") } },
            { BitmapFormat.Dxt5,          new BitmapFormatDefinition { FourCc = DDSFourCC.FromString("DXT5") } },
            { BitmapFormat.A4R4G4B4Font,  new BitmapFormatDefinition { BitsPerPixel = 16, ABitMask = 0xF000, RBitMask = 0x0F00, GBitMask = 0x00F0, BBitMask = 0x000F } },
            { BitmapFormat.Dxn,           new BitmapFormatDefinition { FourCc = DDSFourCC.FromString("ATI2") } },
            { BitmapFormat.Abgrfp16,      new BitmapFormatDefinition { FourCc = 0x00000071} },
            { BitmapFormat.Abgrfp32,      new BitmapFormatDefinition { FourCc = 0x00000074} },
