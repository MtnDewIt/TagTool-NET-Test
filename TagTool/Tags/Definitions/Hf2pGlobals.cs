...
{
    [TagStructure(Name = "hf2p_globals", Tag = "hf2p", Size = 0xC, MinVersion = CacheVersion.Eldorado498295)]
    public class Hf2pGlobals : TagStructure
	{
        public List<Armor> RaceArmors;

        [TagStructure(Size = 0xC, MinVersion = CacheVersion.Eldorado498295)]
        public class Armor : TagStructure
		{
            ...
            public class Gender : TagStructure
			{
                ...
                [TagStructure(Size = 0x34, MinVersion = CacheVersion.Eldorado498295)]
