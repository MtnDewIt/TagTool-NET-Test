...
namespace TagTool.Tags.Definitions
{
    ...
    [TagStructure(Name = "game_progression", Tag = "gpdt", Size = 0x44, MinVersion = CacheVersion.EldoradoED)]
    public class GameProgression : TagStructure
	{
        ...
        [TagField(Flags = Padding, Length = 8, MinVersion = CacheVersion.EldoradoED)]
        public byte[] Unused;
