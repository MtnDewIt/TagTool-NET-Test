...
namespace TagTool.Tags.Definitions
{
    ...
    [TagStructure(Name = "gui_widget_animation_collection_definition", Tag = "wacd", Size = 0x280, MinVersion = CacheVersion.Halo3ODST, Platform = CachePlatform.MCC)]
    public class GuiWidgetAnimationCollectionDefinition : TagStructure
    {
        ...
        [TagField(ValidTags = new[] { "wgan" }, Platform = CachePlatform.MCC, MaxVersion = CacheVersion.Halo3Retail)]
