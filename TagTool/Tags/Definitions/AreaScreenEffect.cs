...
namespace TagTool.Tags.Definitions
{
    ...
    [TagStructure(Name = "area_screen_effect", Tag = "sefc", Size = 0xC, MinVersion = CacheVersion.HaloOnlineEDLegacy, MaxVersion = CacheVersion.HaloOnline700123)]
    [TagStructure(Name = "area_screen_effect", Tag = "sefc", Size = 0x14, MinVersion = CacheVersion.HaloOnlineED, MaxVersion = CacheVersion.HaloOnlineED)]
    ...
    public class AreaScreenEffect : TagStructure
	{
        ...
        [TagStructure(Size = 0x9C, MinVersion = CacheVersion.HaloOnlineEDLegacy, MaxVersion = CacheVersion.HaloOnline700123)]
