...
namespace TagTool.Tags.Definitions
{
    ...
    public class TextureRenderList : TagStructure
	{
        ...
        [TagStructure(Size = 0x4C, MinVersion = CacheVersion.HaloOnlineED, MaxVersion = CacheVersion.HaloOnline155080)]
        ...
        public class TextureRenderMannequin : TagStructure
		{
            ...
            [TagField(Length = 0x3, Flags = TagFieldFlags.Padding, MaxVersion = CacheVersion.HaloOnline155080)]
            public byte[] Padding;
