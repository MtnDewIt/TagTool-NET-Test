...
namespace TagTool.Porting
{
    public partial class PortingContext
    {
        ...
        public GameCache BlamCache { get; }

        public RenderGeometryConverter GeometryConverter { get; private set; }
        ...
        public PortingContext(GameCacheHaloOnlineBase cacheContext, GameCache blamCache)
        {
        ...
        public CachedTag PortTag(CachedTag tagToPort, PortingFlags portingFlags = PortingFlags.Default, string[] optMpObjectParams = null)
        {
            ...
            if (optMpObjectParams == null)
                optMpObjectParams = new string[] { };
            ...
            try
            {
                ...
                using (var blamCacheStream = BlamCache is GameCacheModPackage ? ((GameCacheModPackage)BlamCache).OpenCacheRead(cacheStream) : BlamCache.OpenCacheRead())
                {
                    ...
                    CachedTag edTag = ConvertTag(cacheStream, blamCacheStream, tagToPort);
                    Flags = oldFlags;

                    if (FlagIsSet(PortingFlags.MPobject))
                        TestForgePaletteCompatible(cacheStream, tagToPort, optMpObjectParams);
