...
{
    public partial class PortingContextHaloOnline : PortingContext
    {
        ...
        public PortingContextHaloOnline(GameCacheHaloOnlineBase cacheContext, GameCache blamCache) : base(cacheContext, blamCache)
        {
        }
